...
exports.main = main;
const TestCoverageAnalyzer_1 = require("./analyzer/TestCoverageAnalyzer");
...
async function main() {
    ...
    try {
        ...
        const analyzer = new TestCoverageAnalyzer_1.TestCoverageAnalyzer(allPackages, rootPath);
...
//# sourceMappingURL=demo-test-coverage.js.map