...
async function main() {
    ...
    try {
        ...
        const result = await analyzer.analyzeCodebase(true, // includeArchitecture
        true, // includeScripts
        ...
        if (result.dependencyGraph.circularDependencies.length > 0) {
            ...
            result.dependencyGraph.circularDependencies.slice(0, 3).forEach((cycle, index) => {
...
//# sourceMappingURL=demo-comprehensive.js.map