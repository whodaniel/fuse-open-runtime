...
exports.runDatabaseModelUsageDemo = runDatabaseModelUsageDemo;
const FileSystemScanner_1 = require("./scanner/FileSystemScanner");
const DatabaseModelUsageAnalyzer_1 = require("./analyzer/DatabaseModelUsageAnalyzer");
async function runDatabaseModelUsageDemo() {
    ...
    try {
        ...
        const analyzer = new DatabaseModelUsageAnalyzer_1.DatabaseModelUsageAnalyzer(allPackages, rootPath);
...
//# sourceMappingURL=demo-database-model-usage.js.map