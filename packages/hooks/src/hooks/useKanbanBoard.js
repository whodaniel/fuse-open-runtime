...
import { DataType, ViewType } from '@the-new-fuse/fairtable-core';
export const useKanbanBoard = ({ suggestionService, initialSuggestions = [], initialTodos = [], retryAttempts = 3 }) => {
    ...
    const { state: { suggestions, todos }, canUndo, canRedo, undo, redo, set: setState, reset: resetState } = useUndoRedo({
