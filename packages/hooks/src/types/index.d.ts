...
export declare const AuthContext: import("react").Context<AuthContextProps | null>;
export declare const ApiClientContext: import("react").Context<ApiClientContextProps | null>;
export declare const WebSocketContext: import("react").Context<WebSocketContextProps | null>;
export declare const FeatureToggleContext: import("react").Context<FeatureToggleContextProps | null>;
export declare const SuggestionActionsContext: import("react").Context<SuggestionActionsContextProps | null>;
