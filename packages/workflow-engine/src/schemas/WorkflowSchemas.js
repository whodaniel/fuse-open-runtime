...
// Enums
exports.WorkflowStatusSchema = zod_1.z.nativeEnum(WorkflowTypes_1.WorkflowStatus);
exports.WorkflowExecutionStatusSchema = zod_1.z.nativeEnum(WorkflowTypes_1.WorkflowExecutionStatus);
exports.AgentTypeSchema = zod_1.z.nativeEnum(WorkflowTypes_1.AgentType);
exports.WorkflowNodeTypeSchema = zod_1.z.nativeEnum(WorkflowTypes_1.WorkflowNodeType);
exports.VariableTypeSchema = zod_1.z.nativeEnum(WorkflowTypes_1.VariableType);
exports.VariableScopeSchema = zod_1.z.nativeEnum(WorkflowTypes_1.VariableScope);
exports.TriggerTypeSchema = zod_1.z.nativeEnum(WorkflowTypes_1.TriggerType);
exports.NodeExecutionStatusSchema = zod_1.z.nativeEnum(WorkflowTypes_1.NodeExecutionStatus);
exports.WorkflowEventTypeSchema = zod_1.z.nativeEnum(WorkflowTypes_1.WorkflowEventType);
exports.WorkflowSortFieldSchema = zod_1.z.nativeEnum(WorkflowTypes_1.WorkflowSortField);
exports.ExecutionSortFieldSchema = zod_1.z.nativeEnum(WorkflowTypes_1.ExecutionSortField);
// Helper schemas
