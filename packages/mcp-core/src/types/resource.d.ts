 ...
 */
export type { ResourceHandler, MCPResource, ResourceContent, ResourcePermissions, AccessControlEntry, ResourceCaching, ResourceCallback } from '../interfaces/IMCPResource';
/**
