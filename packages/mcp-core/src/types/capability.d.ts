 ...
 */
export type { MCPCapability, CapabilityMetadata, CapabilityDependency, CapabilityStatus, CapabilityMetrics, CapabilityRegistry } from '../interfaces/IMCPCapability';
/**
