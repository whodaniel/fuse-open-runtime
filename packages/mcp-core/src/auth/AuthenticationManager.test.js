...
describe('AuthenticationManager', () => {
    ...
    describe('Token Management', () => {
        ...
        it('should reject refresh with invalid refresh token', async () => {
            await expect(authManager.refreshToken('invalid_refresh_token')).rejects.toThrow('Invalid refresh token');
        });
    ...
    describe('Account Lockout', () => {
        it('should lock account after max failed attempts', async () => {
            ...
            await expect(authManager.authenticateConnection(credentials)).rejects.toThrow('Account is locked due to too many failed attempts');
        });
    ...
    describe('Error Handling', () => {
        it('should throw error for unsupported authentication type', async () => {
            ...
            await expect(authManager.authenticateConnection(credentials)).rejects.toThrow('Unsupported authentication type: unsupported');
        });
    ...
    describe('Token Cleanup', () => {
        it('should clean up expired tokens', (done) => {
            ...
            const shortExpiryAuthManager = new AuthenticationManager_1.AuthenticationManager({
...
//# sourceMappingURL=AuthenticationManager.test.js.map