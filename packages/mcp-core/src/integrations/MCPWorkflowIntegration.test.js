  ...
  describe('executeWorkflowStep', () => {
    ...
    it('should resolve parameters with context variables', async () => {
      const step: WorkflowStep = {
        ...
        mcpService: 'test-service',
        mcpMethod: 'test-method',
        parameters: { `, message, '${variables.greeting}` ${input.name}`', count, '${stepResults.previous.count}`');
            const context = {
                executionId: 'exec-5',
                workflowId: 'workflow-1',
                ...
                variables: { greeting: 'Hello',
                    let, capturedRequest: IMCPMessage_1.MCPRequest | null, null: ,
                    mockClient, : .sendRequest = jest.fn().mockImplementation((request) => {
            ...
            it('should emit step events', async () => {
                ...
                const stepCompletedPromise = new Promise((resolve) => {
        ...
        describe('delegateTask', () => {
            ...
            it('should delegate task successfully', async () => {
                ...
                expect(result.status).toBe(IMCPWorkflowIntegration_1.TaskExecutionStatus.COMPLETED);
            ...
            it('should handle service not found', async () => {
                ...
                expect(result.status).toBe(IMCPWorkflowIntegration_1.TaskExecutionStatus.FAILED);
            });
        ...
        describe('trackMCPExecution', () => {
            ...
            it('should track execution status', async () => {
                ...
                expect(status.status).toBe(IMCPWorkflowIntegration_1.TaskExecutionStatus.COMPLETED);
        ...
        describe('execution statistics', () => {
            ...
            it('should provide execution statistics', async () => {
                const task1 = { id: 'task-1', type: 'test', parameters: {} };
                const task2 = { id: 'task-2', type: 'test', parameters: {} };
...
//# sourceMappingURL=MCPWorkflowIntegration.test.js.map