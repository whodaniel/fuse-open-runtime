    ...
    send(data) {
        ...
        describe('MCPClient', () => {
            ...
            beforeEach(() => {
                ...
                client = new MCPClient_1.MCPClient(config);
            });
            afterEach(async () => {
            ...
            describe('Statistics and Status', () => {
                ...
                test('should provide client status', async () => {
                    ...
                    expect(status.connectionStatus).toBe(IMCPConnection_1.ConnectionStatus.DISCONNECTED);
            ...
            describe('Error Handling', () => {
                test('should handle connection timeout', async () => {
                    ...
                    const timeoutClient = new MCPClient_1.MCPClient(shortTimeoutConfig);
                ...
                test('should handle request timeout', async () => {
                    ...
                    const timeoutClient = new MCPClient_1.MCPClient({
                        ...config,
                        timeout: 100
                    });
