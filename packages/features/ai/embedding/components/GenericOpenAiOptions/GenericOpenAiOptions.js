...
exports.GenericOpenAiEmbeddingOptions = GenericOpenAiEmbeddingOptions;
...
function GenericOpenAiEmbeddingOptions({ settings }) {
    const [showAdvancedControls, setShowAdvancedControls] = (0, react_1.useState)(false);
    ...
    defaultValue = { settings } === null || settings === void 0 ? void 0 : settings.EmbeddingBasePath;
}
required;
autoComplete = "off";
spellCheck = { false:  } /  >
...
defaultValue = { settings } === null || settings === void 0 ? void 0 : settings.OpenAiOrg;
autoComplete = "off";
spellCheck = { false:  } /  >
    /div>
    < /div>;
