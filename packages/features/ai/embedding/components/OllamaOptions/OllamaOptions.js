...
exports.OllamaEmbeddingOptions = OllamaEmbeddingOptions;
...
function OllamaEmbeddingModelSelection({ settings, basePath = null }) {
    ...
    (0, react_1.useEffect)(() => {
        ...
        () => {
            ...
            setError(null);
            try {
                const { models } = await system_1.default.fetchOllamaModels(basePath);
                setModels(models);
            }
            catch (error) {
...
/optgroup>
    ...
    < /div>;
;
function OllamaEmbeddingOptions({ settings }) {
