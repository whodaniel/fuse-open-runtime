...
exports.AzureAiOptions = AzureAiOptions;
const STYLES = {
...
function AzureAiOptions({ settings }) {
    ...
    defaultValue = { settings } === null || settings === void 0 ? void 0 : settings.AzureOpenAiEndpoint;
}
required;
autoComplete = "off";
spellCheck = { false:  } /  >
...
defaultValue = {}(settings === null || settings === void 0 ? void 0 : settings.AzureOpenAiKey) ? "*".repeat(20) : "";
required;
autoComplete = "off";
spellCheck = { false:  } /  >
    /div>
...
defaultValue = { settings } === null || settings === void 0 ? void 0 : settings.AzureOpenAiEmbeddingModelPref;
required;
autoComplete = "off";
spellCheck = { false:  } /  >
    /div>
