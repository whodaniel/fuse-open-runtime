    ...
    <div className={STYLES.container}>
      <div className={STYLES.inputGroup}>
        <div className={STYLES.inputContainer}>
          <label className={STYLES.label}>Azure Service Endpoint</label>
          <input
            type="url"
            ...
            defaultValue={
              settings === null || settings === void 0 ? void 0 : settings.AzureOpenAiEndpoint
            }
            required
            autoComplete="off"
            spellCheck={false}
        ...
        <div className={STYLES.inputContainer}>
          ...
          <input
            ...
            defaultValue={
              (settings === null || settings === void 0 ? void 0 : settings.AzureOpenAiKey)
                ? '*'.repeat(20)
                : ''
            }
            required
        ...
        <div className={STYLES.inputContainer}>
          <label className={STYLES.label}>Embedding Deployment Name</label>
          <input
            type="text"
