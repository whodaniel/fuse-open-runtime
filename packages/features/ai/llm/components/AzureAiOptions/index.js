...
exports.default = AzureAiOptions;
import jsx_runtime_1 from 'react/jsx-runtime';
function AzureAiOptions({ settings }) {
  return (0, jsx_runtime_1.jsxs)('div', {
    className: 'w-full flex flex-col gap-y-7 mt-1.5',
    children: [
      (0, jsx_runtime_1.jsxs)('div', {
        className: 'w-full flex items-center gap-[36px]',
        children: [
          (0, jsx_runtime_1.jsxs)('div', {
            ...
            children: [
              (0, jsx_runtime_1.jsx)('label', {
                ...
                children: 'Azure Service Endpoint',
              }),
      ...
      (0, jsx_runtime_1.jsx)('div', {
        ...
        children: (0, jsx_runtime_1.jsxs)('div', {
          ...
          children: [
            (0, jsx_runtime_1.jsx)('label', {
              className: 'text-white text-sm font-semibold block mb-3',
              children: 'Chat Model Token Limit',
            }),
            (0, jsx_runtime_1.jsxs)('select', {
              ...
              children: [
                (0, jsx_runtime_1.jsx)('option', {
                  value: 4096,
                  children: '4,096 (gpt-3.5-turbo)',
                }),
                (0, jsx_runtime_1.jsx)('option', {
                  value: 16384,
                  children: '16,384 (gpt-3.5-16k)',
                }),
                (0, jsx_runtime_1.jsx)('option', { value: 8192, children: '8,192 (gpt-4)' }),
                (0, jsx_runtime_1.jsx)('option', { value: 32768, children: '32,768 (gpt-4-32k)' }),
                (0, jsx_runtime_1.jsx)('option', {
                  value: 128000,
                  children: '128,000 (gpt-4-turbo,gpt-4o,gpt-4o-mini)',
                }),
              ],
            }),
          ],
