  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      ...
      !settings?.credentialsOnly &&
        (0, jsx_runtime_1.jsx)(MistralModelSelection, { settings: settings, apiKey: mistralKey }),
    ],
  });
}
      ...
      children: [
        ...
        (0, jsx_runtime_1.jsx)('select', {
          ...
          children: (0, jsx_runtime_1.jsx)('option', {
            disabled: true,
            selected: true,
            children: !!apiKey ? '-- loading available models --' : '-- waiting for API key --',
          }),
        }),
      ],
    });
      ...
      (0, jsx_runtime_1.jsx)('select', {
        ...
        children:
          ...
          (0, jsx_runtime_1.jsx)('optgroup', {
            label: 'Available Mistral Models',
