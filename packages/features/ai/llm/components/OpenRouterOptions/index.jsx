...
function OpenRouterOptions({ settings }) {
  return (0, jsx_runtime_1.jsxs)('div', {
    className: 'flex flex-col gap-y-4 mt-1.5',
    children: [
      (0, jsx_runtime_1.jsxs)('div', {
        ...
        children: [
          ...
          !settings?.credentialsOnly &&
            (0, jsx_runtime_1.jsx)(OpenRouterModelSelection, { settings: settings }),
        ],
      }),
      (0, jsx_runtime_1.jsx)(AdvancedControls, { settings: settings }),
    ],
  });
}
      ...
      (0, jsx_runtime_1.jsxs)('button', {
        ...
        children: [
          ...
          showAdvancedControls
            ? (0, jsx_runtime_1.jsx)(react_1.CaretUp, { size: 14, className: 'ml-1' })
            : (0, jsx_runtime_1.jsx)(react_1.CaretDown, { size: 14, className: 'ml-1' }),
        ],
      }),
  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      ...
      (0, jsx_runtime_1.jsx)('select', {
        ...
        className:
          'border-none bg-theme-settings-input-bg border-gray-500 text-white text-sm rounded-lg block w-full p-2.5',
        children: Object.keys(groupedModels)
          .sort()
          .map((organization) =>
            (0, jsx_runtime_1.jsx)(
              'optgroup',
              {
                label: organization,
                children: groupedModels[organization].map((model) =>
                  (0, jsx_runtime_1.jsx)(
                    'option',
                    {
                      value: model.id,
