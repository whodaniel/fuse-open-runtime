...
const OPENROUTER_COMMON_URLS = ['https://openrouter.ai/api/v1'];
  ...
  return (
    <div className="w-full flex flex-col gap-y-7">
      <div className="w-full flex items-start gap-[36px] mt-1.5">
        <OpenRouterModelSelection settings={settings} basePath={basePath.value} apiKey={apiKey} />
      ...
      try {
        ...
        if (models && models.length > 0) {
          ...
          const groupedModels = models.reduce(
            (acc: { [key: string]: VendorModel[] }, model: VendorModel) => {
          ...
          const groups: ModelVendorGroup[] = Object.entries(groupedModels).map(
            ([vendor, models]) => ({
              vendor,
