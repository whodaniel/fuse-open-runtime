...
import { BaseLLMOptionsProps, ModelSelectionProps } from '../../types/index.js';
import system from "@/models/system";

interface AnthropicAiSettings extends BaseLLMOptionsProps {
  settings: {
    AnthropicAiBasePath?: string;
    AnthropicAiApiKey?: string;
    AnthropicAiModelPref?: string;
    AnthropicAiTokenLimit?: number;
  };
}
      ...
      >
        {customModels.map((model) => (
          <option
            key={model.id}
            value={model.id}
            selected={settings.AnthropicAiModelPref === model.id}
          >
            {model.id}
          </option>
        ))}
