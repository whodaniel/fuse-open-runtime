            ...
            (0, jsx_runtime_1.jsxs)('div', {
              ...
              children: [
                ...
                (0, jsx_runtime_1.jsx)('p', {
                  ...
                  children: 'LocalAI as your LLM requires you to set an embedding service to use.',
                }),
              ],
            }),
        ...
        children: [
          !settings?.credentialsOnly &&
            (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
              children: [
                (0, jsx_runtime_1.jsx)(LocalAIModelSelection, {
                  settings: settings,
            ...
            children: [
              (0, jsx_runtime_1.jsx)('div', {
                ...
                children: (0, jsx_runtime_1.jsxs)('label', {
                  className: 'text-white text-sm font-semibold flex items-center gap-x-2',
                  children: [
                    'Local AI API Key',
                    ' ',
                    (0, jsx_runtime_1.jsx)('p', {
                      className: '!text-xs !italic !font-thin',
                      children: 'optional',
                    }),
                  ],
                }),
...
function LocalAIModelSelection({ settings, basePath = null, apiKey = null }) {
  ...
  (0, react_1.useEffect)(() => {
    async function findCustomModels() {
      ...
      setLoading(true);
      const { models } = await system_1.default.customModels(
        'localai',
