            ...
            children: [
              ...
              (0, jsx_runtime_1.jsxs)('div', {
                ...
                children: [
                  (0, jsx_runtime_1.jsx)('label', {
                    className: 'text-white text-sm font-semibold block mb-3',
                    children: 'Safety Setting',
                  }),
                  (0, jsx_runtime_1.jsxs)('select', {
                    name: 'GeminiSafetySetting',
                    defaultValue: settings?.GeminiSafetySetting || 'BLOCK_MEDIUM_AND_ABOVE',
                    required: true,
                    className:
                      'border-none bg-theme-settings-input-bg border-gray-500 text-white text-sm rounded-lg block w-full p-2.5',
                    children: [
                      (0, jsx_runtime_1.jsx)('option', { value: 'BLOCK_NONE', children: 'None' }),
