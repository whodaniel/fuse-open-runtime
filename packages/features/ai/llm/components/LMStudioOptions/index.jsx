    ...
    children: [
      showAlert &&
        (0, jsx_runtime_1.jsxs)('div', {
          className:
            'flex flex-col md:flex-row md:items-center gap-x-2 text-white mb-6 bg-blue-800/30 w-fit rounded-lg px-4 py-2',
          children: [
            (0, jsx_runtime_1.jsxs)('div', {
              className: 'gap-x-2 flex items-center',
              children: [
                (0, jsx_runtime_1.jsx)(react_2.Info, { size: 12, className: 'hidden md:visible' }),
                (0, jsx_runtime_1.jsx)('p', {
                  className: 'text-sm md:text-base',
                  children: 'LMStudio as your LLM requires you to set an embedding service to use.',
                }),
              ],
            }),
            (0, jsx_runtime_1.jsx)('a', {
              href: paths_1.default.settings.embedder.modelPreference(),
              className: 'text-sm md:text-base my-2 underline',
              children: 'Manage embedding \u2192',
            }),
          ],
        }),
      (0, jsx_runtime_1.jsxs)('div', {
        ...
        children: [
          (0, jsx_runtime_1.jsx)(LMStudioModelSelection, {
            settings: settings,
        ...
        children: (0, jsx_runtime_1.jsx)('div', {
          ...
          children: (0, jsx_runtime_1.jsxs)('div', {
            ...
            children: [
              ...
              (0, jsx_runtime_1.jsx)('p', {
                className: 'text-xs leading-[18px] font-base text-white text-opacity-60 mt-2',
                children: 'Enter the URL where LM Studio is running.',
              }),
            ],
          }),
        }),
...
function LMStudioModelSelection({ settings, basePath = null }) {
      ...
      children: [
        ...
        (0, jsx_runtime_1.jsx)('select', {
          ...
          children: (0, jsx_runtime_1.jsx)('option', {
            disabled: true,
            selected: true,
            children: !!basePath ? '--loading available models--' : 'Enter LM Studio URL first',
          }),
        }),
        (0, jsx_runtime_1.jsx)('p', {
          className: 'text-xs leading-[18px] font-base text-white text-opacity-60 mt-2',
  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      ...
      (0, jsx_runtime_1.jsx)('p', {
        className: 'text-xs leading-[18px] font-base text-white text-opacity-60 mt-2',
        children: 'Choose the LM Studio model you want to use for your conversations.',
      }),
    ],
  });
}
