...
function XAILLMOptions({ settings }) {
  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    className: 'flex gap-[36px] mt-1.5',
    children: [
      ...
      !settings?.credentialsOnly &&
        (0, jsx_runtime_1.jsx)(XAIModelSelection, { settings: settings, apiKey: apiKey }),
    ],
  });
}
function XAIModelSelection({ apiKey, settings }) {
    ...
    return (0, jsx_runtime_1.jsxs)('div', {
      ...
      children: [
        ...
        (0, jsx_runtime_1.jsx)('select', {
          ...
          disabled: true,
          className:
            'border-none bg-theme-settings-input-bg text-theme-text-primary border-theme-border text-sm rounded-lg block w-full p-2.5',
        ...
        (0, jsx_runtime_1.jsx)('p', {
          className: 'text-xs leading-[18px] font-base text-theme-text-primary opacity-60 mt-2',
          children: 'Enter a valid API key to view all available models for your account.',
        }),
      ],
    });
  }
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      ...
      (0, jsx_runtime_1.jsx)('p', {
        className: 'text-xs leading-[18px] font-base text-theme-text-primary opacity-60 mt-2',
        children: 'Select the xAI model you want to use for your conversations.',
      }),
    ],
  });
}
