...
exports.default = HuggingFaceOptions;
import jsx_runtime_1 from 'react/jsx-runtime';
function HuggingFaceOptions({ settings }) {
      ...
      children: [
        (0, jsx_runtime_1.jsxs)('div', {
          ...
          children: [
            (0, jsx_runtime_1.jsx)('label', {
              ...
              children: 'HuggingFace Inference Endpoint',
            }),
        ...
        (0, jsx_runtime_1.jsxs)('div', {
          ...
          children: [
            (0, jsx_runtime_1.jsx)('label', {
              className: 'text-white text-sm font-semibold block mb-3',
              children: 'HuggingFace Access Token',
            }),
            (0, jsx_runtime_1.jsx)('input', {
              type: 'password',
