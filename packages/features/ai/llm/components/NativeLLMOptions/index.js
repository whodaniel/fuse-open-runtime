  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      (0, jsx_runtime_1.jsx)('div', {
        className:
          'flex flex-col md:flex-row md:items-center gap-x-2 text-white mb-4 bg-orange-800/30 w-fit rounded-lg px-4 py-2',
        children: (0, jsx_runtime_1.jsxs)('div', {
          className: 'gap-x-2 flex items-center',
          children: [
            (0, jsx_runtime_1.jsx)(react_2.Flask, { size: 18 }),
            (0, jsx_runtime_1.jsx)('p', {
              className: 'text-sm md:text-base',
              children: 'Using a locally hosted LLM is experimental. Use with caution.',
            }),
          ],
        }),
      }),
      (0, jsx_runtime_1.jsx)('div', {
        ...
        children: (0, jsx_runtime_1.jsx)(NativeModelSelection, { settings: settings }),
      }),
    ],
  });
}
