  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      (0, jsx_runtime_1.jsxs)('div', {
        ...
        children: [
          (0, jsx_runtime_1.jsx)(KoboldCPPModelSelection, {
            settings: settings,
        ...
        children: (0, jsx_runtime_1.jsx)('div', {
          ...
          children: (0, jsx_runtime_1.jsxs)('div', {
            ...
            children: [
                    ...
                    : (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {
                        children:
                          ...
                          (0, jsx_runtime_1.jsx)('button', {
                            ...
                            className:
                              'border-none bg-primary-button text-xs font-medium px-2 py-1 rounded-lg hover:bg-secondary hover:text-white shadow-[0_4px_14px_rgba(0,0,0,0.25)]',
              ...
              (0, jsx_runtime_1.jsx)('p', {
                className: 'text-xs leading-[18px] font-base text-white text-opacity-60 mt-2',
                children: 'Enter the URL where KoboldCPP is running.',
              }),
            ],
          }),
        }),
...
function KoboldCPPModelSelection({ settings, basePath = null }) {
  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      ...
      (0, jsx_runtime_1.jsx)('p', {
        className: 'text-xs leading-[18px] font-base text-white text-opacity-60 mt-2',
        children: 'Choose the KoboldCPP model you want to use for your conversations.',
      }),
    ],
  });
}
