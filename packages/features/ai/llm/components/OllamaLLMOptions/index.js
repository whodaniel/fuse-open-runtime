...
const useProviderEndpointAutoDiscovery_1 = __importDefault(
  require('@/hooks/useProviderEndpointAutoDiscovery')
);
function OllamaLLMOptions({ settings }) {
  ...
  } = (0, useProviderEndpointAutoDiscovery_1.default)({
    provider: 'ollama',
    initialBasePath: settings?.OllamaLLMBasePath,
    ENDPOINTS: constants_1.OLLAMA_COMMON_URLS,
  });
  const [performanceMode, setPerformanceMode] = (0, react_1.useState)(
  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      (0, jsx_runtime_1.jsxs)('div', {
        className: 'w-full flex items-start gap-[36px] mt-1.5',
        children: [
          (0, jsx_runtime_1.jsx)(OllamaLLMModelSelection, {
            settings: settings,
          ...
          (0, jsx_runtime_1.jsxs)('div', {
            ...
            children: [
              ...
              (0, jsx_runtime_1.jsx)('p', {
                className: 'text-xs leading-[18px] font-base text-white text-opacity-60 mt-2',
                children: 'Maximum number of tokens for context and response.',
              }),
            ],
          }),
        ],
      ...
      (0, jsx_runtime_1.jsx)('div', {
        ...
        children: (0, jsx_runtime_1.jsxs)('button', {
          ...
          children: [
            ...
            ' advanced settings',
            showAdvancedControls
              ? (0, jsx_runtime_1.jsx)(react_2.CaretUp, { size: 14, className: 'ml-1' })
              : (0, jsx_runtime_1.jsx)(react_2.CaretDown, { size: 14, className: 'ml-1' }),
          ],
        }),
      }),
      (0, jsx_runtime_1.jsx)('div', {
        hidden: !showAdvancedControls,
              ...
              children: [
                (0, jsx_runtime_1.jsxs)('div', {
                  ...
                  children: [
                    ...
                    loading
                      ? (0, jsx_runtime_1.jsx)(Preloader_1.default, { size: '6' })
                      : (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {
                          children:
                            ...
                            (0, jsx_runtime_1.jsx)('button', {
                              ...
                              className:
                                'bg-primary-button text-xs font-medium px-2 py-1 rounded-lg hover:bg-secondary hover:text-white shadow-[0_4px_14px_rgba(0,0,0,0.25)]',
                ...
                (0, jsx_runtime_1.jsx)('p', {
                  className: 'text-xs leading-[18px] font-base text-white text-opacity-60 mt-2',
                  children: 'Enter the URL where Ollama is running.',
                }),
              ],
            }),
            (0, jsx_runtime_1.jsxs)('div', {
              ...
              children: [
                ...
                (0, jsx_runtime_1.jsxs)('select', {
                  ...
                  children: [
                    (0, jsx_runtime_1.jsx)('option', { value: '0', children: 'No cache' }),
                    (0, jsx_runtime_1.jsx)('option', { value: '300', children: '5 minutes' }),
                    (0, jsx_runtime_1.jsx)('option', { value: '3600', children: '1 hour' }),
                    (0, jsx_runtime_1.jsx)('option', { value: '-1', children: 'Forever' }),
                  ],
                }),
            ...
            (0, jsx_runtime_1.jsxs)('div', {
              ...
              children: [
                (0, jsx_runtime_1.jsxs)('label', {
                  className: 'text-white text-sm font-semibold mb-2 flex items-center',
                  children: [
                    'Performance Mode',
                    (0, jsx_runtime_1.jsx)(react_2.Info, {
                      size: 16,
                ...
                (0, jsx_runtime_1.jsxs)('select', {
                  ...
                  children: [
                    (0, jsx_runtime_1.jsx)('option', { value: 'base', children: 'Base (Default)' }),
                    (0, jsx_runtime_1.jsx)('option', { value: 'maximum', children: 'Maximum' }),
                  ],
                }),
                (0, jsx_runtime_1.jsx)('p', {
                  className: 'text-xs leading-[18px] font-base text-white text-opacity-60 mt-2',
                  children: 'Choose the performance mode for the Ollama model.',
                }),
                (0, jsx_runtime_1.jsxs)(react_tooltip_1.Tooltip, {
                  ...
                  children: [
                    (0, jsx_runtime_1.jsxs)('p', {
                      ...
                      children: [
                        (0, jsx_runtime_1.jsx)('strong', { children: 'Note:' }),
                        ' Only change this setting if you understand its implications on performance and resource usage.',
                      ],
                    }),
                    (0, jsx_runtime_1.jsx)('br', {}),
                    (0, jsx_runtime_1.jsxs)('p', {
                      children: [
                        (0, jsx_runtime_1.jsx)('strong', { children: 'Base:' }),
                        ' Ollama automatically limits the context to 2048 tokens, reducing VRAM usage. Suitable for most users.',
                      ],
                    }),
                    (0, jsx_runtime_1.jsx)('br', {}),
                    (0, jsx_runtime_1.jsxs)('p', {
                      children: [
                        (0, jsx_runtime_1.jsx)('strong', { children: 'Maximum:' }),
                        ' Uses the full context window (up to Max Tokens). May increase VRAM usage significantly.',
                      ],
                    }),
                  ],
                }),
...
function OllamaLLMModelSelection({ settings, basePath = null }) {
      ...
      children: [
        ...
        (0, jsx_runtime_1.jsx)('select', {
          ...
          children: (0, jsx_runtime_1.jsx)('option', {
            disabled: true,
            selected: true,
            children: !!basePath ? '--loading available models--' : 'Enter Ollama URL first',
          }),
        }),
        (0, jsx_runtime_1.jsx)('p', {
          className: 'text-xs leading-[18px] font-base text-white text-opacity-60 mt-2',
  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      ...
      (0, jsx_runtime_1.jsx)('p', {
        className: 'text-xs leading-[18px] font-base text-white text-opacity-60 mt-2',
        children: 'Choose the Ollama model you want to use for your conversations.',
      }),
    ],
  });
}
