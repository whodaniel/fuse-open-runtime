...
exports.default = AwsBedrockLLMOptions;
import react_1 from '@phosphor-icons/react';
import react_2 from 'react';
import jsx_runtime_1 from 'react/jsx-runtime';
import regions_1 from './regions.js';
function AwsBedrockLLMOptions({ settings }) {
  const [useSessionToken, setUseSessionToken] = (0, react_2.useState)(
  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      !settings?.credentialsOnly &&
        (0, jsx_runtime_1.jsx)('div', {
          ...
          children: (0, jsx_runtime_1.jsxs)('div', {
            ...
            children: [
              (0, jsx_runtime_1.jsx)(react_1.Info, { size: 40 }),
                ...
                children: [
                  ...
                  (0, jsx_runtime_1.jsxs)('a', {
                    ...
                    children: [
                      ...
                      (0, jsx_runtime_1.jsx)(react_1.ArrowSquareOut, { size: 14 }),
                    ],
                  }),
                ],
              }),
          ...
          (0, jsx_runtime_1.jsxs)('div', {
            ...
            children: [
              (0, jsx_runtime_1.jsx)('label', {
                ...
                children: 'Use session token',
              }),
              (0, jsx_runtime_1.jsx)('p', {
                className: 'text-theme-text-secondary text-sm',
                children: 'Select the method to authenticate with AWS Bedrock.',
              }),
            ],
          }),
          (0, jsx_runtime_1.jsxs)('div', {
            className:
              'flex items-center justify-start gap-x-4 bg-theme-settings-input-bg p-2.5 rounded-lg w-fit',
            children: [
              ...
              (0, jsx_runtime_1.jsxs)('label', {
                ...
                children: [
                  ...
                  (0, jsx_runtime_1.jsx)('div', {
                    className:
                      "w-11 h-6 bg-[#4b5563] light:bg-[#e5e7eb] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-[#d1d5db] light:after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-button",
                  }),
                ],
              }),
              (0, jsx_runtime_1.jsx)('span', {
      ...
      (0, jsx_runtime_1.jsxs)('div', {
        className: 'w-full flex items-center gap-[36px] my-1.5',
        children: [
          (0, jsx_runtime_1.jsxs)('div', {
            ...
            children: [
              (0, jsx_runtime_1.jsx)('label', {
                ...
                children: 'AWS Bedrock IAM Access ID',
              }),
              (0, jsx_runtime_1.jsx)('input', {
                type: 'password',
          ...
          (0, jsx_runtime_1.jsxs)('div', {
            ...
            children: [
              (0, jsx_runtime_1.jsx)('label', {
                className: 'text-white text-sm font-semibold block mb-3',
                children: 'AWS Bedrock IAM Access Key',
              }),
              (0, jsx_runtime_1.jsx)('input', {
                type: 'password',
          ...
          useSessionToken &&
            (0, jsx_runtime_1.jsxs)('div', {
              ...
              children: [
                (0, jsx_runtime_1.jsx)('label', {
                  className: 'text-theme-text-primary text-sm font-semibold block mb-3',
                  children: 'AWS Bedrock Session Token',
                }),
                (0, jsx_runtime_1.jsx)('input', {
                  type: 'password',
          ...
          (0, jsx_runtime_1.jsxs)('div', {
            ...
            children: [
              ...
              (0, jsx_runtime_1.jsx)('select', {
                ...
                className:
                  'border-none bg-theme-settings-input-bg text-white placeholder:text-theme-settings-input-placeholder text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5',
                children: regions_1.AWS_REGIONS.map((region) => {
                  return (0, jsx_runtime_1.jsxs)(
                    'option',
                    { value: region.code, children: [region.name, ' (', region.code, ')'] },
                    region.code
                  );
                }),
              }),
