  ...
  const fetchAnalyticsData = async (): Promise<void> => {
    ...
    try {
      ...
      const startDate = startOfDay(
        subDays(endDate, timeRange === '7d' ? 7 : timeRange === '30d' ? 30 : 90)
      );
            ...
            <recharts_1.AreaChart
              data={
                analyticsData === null || analyticsData === void 0
                  ? void 0
                  : analyticsData.userEngagement.weekly
              }
            >
            ...
            <recharts_1.PieChart>
                ...
                data={[
                  {
                    ...
                    value:
                      analyticsData === null || analyticsData === void 0
                        ? void 0
                        : analyticsData.contentAnalysis.sentiment.positive,
                  },
                  {
                    name: 'Neutral',
                    value:
                      analyticsData === null || analyticsData === void 0
                        ? void 0
                        : analyticsData.contentAnalysis.sentiment.neutral,
                  },
                  {
                    name: 'Negative',
                    value:
                      analyticsData === null || analyticsData === void 0
                        ? void 0
                        : analyticsData.contentAnalysis.sentiment.negative,
                  },
                ]}
                cx="50%"
                cy="50%"
              ...
              >
                {COLORS.map((color, index) => (
                  <recharts_1.Cell key={`cell-${index}`} fill={color} />
                ))}
              </recharts_1.Pie>
              <recharts_1.Legend />
              <recharts_1.Tooltip />
          ...
          <recharts_1.ResponsiveContainer>
            <recharts_1.BarChart
              data={
                analyticsData === null || analyticsData === void 0
                  ? void 0
                  : analyticsData.contentAnalysis.topics
              }
            >
              <recharts_1.CartesianGrid strokeDasharray="3 3" />
              ...
              <recharts_1.Bar dataKey="count" fill="#8884d8">
                {analyticsData === null || analyticsData === void 0
                  ? void 0
                  : analyticsData.contentAnalysis.topics.map((entry, index) => (
                      <recharts_1.Cell key={`cell-${index}`} fill={COLORS[index % COLORS.length]} />
                    ))}
              </recharts_1.Bar>
            </recharts_1.BarChart>
          </recharts_1.ResponsiveContainer>
              ...
              data={[
                {
                  ...
                  value:
                    analyticsData === null || analyticsData === void 0
                      ? void 0
                      : analyticsData.moderationStats.actions.warns,
                },
                {
                  name: 'Mutes',
                  value:
                    analyticsData === null || analyticsData === void 0
                      ? void 0
                      : analyticsData.moderationStats.actions.mutes,
                },
                {
                  name: 'Bans',
                  value:
                    analyticsData === null || analyticsData === void 0
                      ? void 0
                      : analyticsData.moderationStats.actions.bans,
                },
                {
                  name: 'Deletes',
                  value:
                    analyticsData === null || analyticsData === void 0
                      ? void 0
                      : analyticsData.moderationStats.actions.deletes,
                },
              ]}
            >
              <recharts_1.CartesianGrid strokeDasharray="3 3" />
                ...
                data={[
                  {
                    ...
                    value:
                      analyticsData === null || analyticsData === void 0
                        ? void 0
                        : analyticsData.moderationStats.appeals.pending,
                  },
                  {
                    name: 'Approved',
                    value:
                      analyticsData === null || analyticsData === void 0
                        ? void 0
                        : analyticsData.moderationStats.appeals.approved,
                  },
                  {
                    name: 'Rejected',
                    value:
                      analyticsData === null || analyticsData === void 0
                        ? void 0
                        : analyticsData.moderationStats.appeals.rejected,
                  },
                ]}
                cx="50%"
                cy="50%"
          ...
          <recharts_1.ResponsiveContainer>
            <recharts_1.LineChart
              data={
                analyticsData === null || analyticsData === void 0
                  ? void 0
                  : analyticsData.userEngagement.retention
              }
            >
              <recharts_1.CartesianGrid strokeDasharray="3 3" />
              <recharts_1.XAxis dataKey="day" />
