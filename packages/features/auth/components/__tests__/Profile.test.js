...
describe('Profile Component', () => {
    ...
    const renderProfile = () => {
        return (0, testUtils_1.render)(value, { Object, : .assign(Object.assign({}, testUtils_2.mockAuthContextValue), { user: mockUser }) } >
            />
    ...
    it('handles form submission correctly', async () => , () => , () => {
        ...
        (0, testUtils_1.render)(value, { Object, : .assign(Object.assign({}, testUtils_2.mockAuthContextValue), { user: mockUser, updateProfile: mockUpdateProfile }) } >
            />
            < /AuthContext_1.AuthContext.Provider>);
        testUtils_1.fireEvent.click(testUtils_1.screen.getByText(/edit profile/i));
        const nameInput = testUtils_1.screen.getByLabelText(/name/i);
    ...
    it('handles theme changes correctly', async () => , () => , () => {
        ...
        (0, testUtils_1.render)(value, { Object, : .assign(Object.assign({}, testUtils_2.mockAuthContextValue), { user: mockUser }) } >
            />
            < /AuthContext_1.AuthContext.Provider>);
        testUtils_1.fireEvent.click(testUtils_1.screen.getByText(/edit profile/i));
