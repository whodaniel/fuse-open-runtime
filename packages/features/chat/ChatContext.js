...
var ChatProvider = function (_a) {
    ...
    var sendMessage = (0, react_1.useCallback)(function (content, attachments) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        message = {
                            ...
                            timestamp: new Date(),
                            type: 'text',
                            attachments: attachments === null || attachments === void 0 ? void 0 : attachments.map(function (file) {
                                return ({
    ...
    var clearChat = (0, react_1.useCallback)(function () {
