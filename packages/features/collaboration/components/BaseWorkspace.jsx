...
const BaseWorkspace = ({ header, sidebar, main, sidebarWidth = 'w-1/4', className = '' }) => {
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      header && (0, jsx_runtime_1.jsx)('div', { className: 'workspace-header', children: header }),
      (0, jsx_runtime_1.jsxs)(split_1.Split, {
        children: [
          (0, jsx_runtime_1.jsx)('div', { className: `workspace-main flex-1`, children: main }),
          sidebar &&
            (0, jsx_runtime_1.jsx)('div', {
              className: `workspace-sidebar ${sidebarWidth}`,
              children: sidebar,
            }),
        ],
      }),
