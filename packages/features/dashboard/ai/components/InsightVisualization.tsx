...
var InsightVisualization = function (_a): any {
  var type = _a.type,
    data = _a.data;
  var theme = (0, material_1.useTheme)();
  var getVisualization = function (): any {
    var _a, _b;
    switch (type) {
      case 'line':
        return (
          <recharts_1.LineChart data={data}>
            ...
            <recharts_1.Line
              ...
              activeDot={{ r: 6 }}
            />
            {((_a = data[0]) === null || _a === void 0 ? void 0 : _a.expected) && (
              <recharts_1.Line
                type="monotone"
                dataKey="expected"
        ...
        return (
          <recharts_1.BarChart data={data}>
            ...
            <recharts_1.Bar
              ...
              radius={[4, 4, 0, 0]}
            />
            {((_b = data[0]) === null || _b === void 0 ? void 0 : _b.target) && (
              <recharts_1.Bar
                dataKey="target"
  ...
  return (
    <material_1.Box sx={{ width: 100 % ', height: 100%' }}>
