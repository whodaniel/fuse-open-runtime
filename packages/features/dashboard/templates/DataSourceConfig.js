...
var DataSourceConfig = function (_a) {
    ...
    Settings
        ...
        < div;
    className = "space-y-4" >
        { config, : .type !== 'custom' && htmlFor, "url": className = "block text-sm font-medium text-gray-700" >
                URL
                < /label>
    ...
    id = "interval";
    type = "number";
    value = { config, : .config.interval || 0 };
    onChange = { function(e) {
    ...
    Type
        ...
        < select;
    id = "auth-type";
    value = {}((_b = config.credentials) === null || _b === void 0 ? void 0 : _b.type) || 'none';
}, onChange = { function(e) {
...
Auth < /option>
    ...
    < /div>;
{
    ((_c = config.credentials) === null || _c === void 0 ? void 0 : _c.type) === 'apiKey' && htmlFor;
    "api-key";
    className = "block text-sm font-medium text-gray-700" >
        API;
    Key
...
disabled = { testStatus, : .loading } >
    ...
    < /Button_1.Button>;
{
    testStatus.success && className;
    "text-green-600" > Connection;
    successful < /span>;
}
{
    testStatus.error && className;
    "text-red-600" > { testStatus, : .error } < /span>;
}
/div>
    < /div>;
{ /* Footer */ }
