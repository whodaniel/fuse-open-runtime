...
var ShareDashboardModal = function (_a) {
    var _b, _c, _d, _e, _f;
    ...
    "radio";
    value = "view";
    checked = { shareConfig, : .type === 'view' };
    onChange = { function(e) {
            return setShareConfig(function (prev) { return (__assign(__assign({}, prev), { type: e.target.value })); });
        } };
    ...
    className = "mt-2" >
        value;
    {
        (_b = shareConfig.recipient) === null || _b === void 0 ? void 0 : _b.type;
    }
    onChange = { function(e) {
            return setShareConfig(function (prev) { return (__assign(__assign({}, prev), { recipient: { type: e.target.value } })); });
        } };
    ...
    value = "public" > Public < /option>
        ...
        < /div>;
    {
        ((_c = shareConfig.recipient) === null || _c === void 0 ? void 0 : _c.type) === 'user' && type;
        "email";
        placeholder = "Enter email address";
        value = {}((_d = shareConfig.recipient) === null || _d === void 0 ? void 0 : _d.email) || '';
    }
    onChange = { function(e) {
            return setShareConfig(function (prev) { return (__assign(__assign({}, prev), { recipient: __assign(__assign({}, prev.recipient), { email: e.target.value }) })); });
        } };
    className = "mt-2" /  > ;
}
    < /div>;
...
min = "0";
value = { expiryDays };
onChange = { function(e) { return setExpiryDays(parseInt(e.target.value, 10)); } };
...
onChange = { function(e) {
        return setShareConfig(function (prev) { return (__assign(__assign({}, prev), { allowExport: e.target.checked })); });
    } };
...
className = "inline-flex items-center" >
    type;
"checkbox";
checked = { shareConfig, : .allowShare };
onChange = { function(e) {
        return setShareConfig(function (prev) { return (__assign(__assign({}, prev), { allowShare: e.target.checked })); });
    } };
className = "form-checkbox" /  >
    className;
"ml-2" > Allow;
...
//# sourceMappingURL=ShareDashboardModal.js.map