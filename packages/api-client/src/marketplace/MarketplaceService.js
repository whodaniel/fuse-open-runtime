...
boolean;
{
     ...
     * Get all available integration listings
     */
    getListings(filter ?  : { type: IntegrationType, category: string, search: string });
    IntegrationListing[];
    {
     ...
     */
    on(event, MarketplaceEvent, listener, (...args) => void );
    void {
     ...
     */
    off(event, MarketplaceEvent, listener, (...args) => void );
    void {
    ...
    async;
    simulateInstallation(listing, IntegrationListing);
    Promise < Integration > {
