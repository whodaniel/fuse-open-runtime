...
import { Integration, IntegrationListing, IntegrationType } from '../integrations/types';
...
export class MarketplaceService {
  ...
  private installationStatus: Map<string, { status: InstallationStatus; message?: string }> =
    new Map();
  ...
  constructor(
    ...
    this.discoveryEndpoint =
      discoveryEndpoint || 'https://api.the-new-fuse.io/integrations/marketplace';
  }
