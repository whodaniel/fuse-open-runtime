...
export class MonitoringDashboardService {
  ...
  constructor(
    ...
    this.refreshInterval = (dashboardConfig as any).refreshInterval || 60000; // Default 1 minute(this as any)): void {
    ...
    try {
      ...
      this.logger.debug('Dashboard metrics updated successfully')): void {
