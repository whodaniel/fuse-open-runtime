...
let MonitoringDashboardService = MonitoringDashboardService_1 = class MonitoringDashboardService {
    ...
    websocketService;
    a2aService;
    logger = new Logger(MonitoringDashboardService_1.name);
    metricsHistory = [];
    alerts = [];
    isCollecting = false;
    ...
    alertsInterval;
    healthCheckInterval;
    constructor(configService, cacheService, queueService, websocketService, a2aService) {
    ...
    async collectCurrentMetrics() {
        ...
        const [systemStats, cacheStats, queueMetrics, websocketMetrics, a2aMetrics, databaseStats,] = await Promise.all([
            this.getSystemStats(),
    ...
    async processAlerts(metrics) {
        ...
        for (const alert of newAlerts) {
            const existingAlert = this.alerts.find(a => a.service === alert.service &&
...
MonitoringDashboardService = MonitoringDashboardService_1 = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [ConfigService, typeof (_a = typeof RedisCacheService !== "undefined" && RedisCacheService) === "function" ? _a : Object, typeof (_b = typeof OptimizedQueueService !== "undefined" && OptimizedQueueService) === "function" ? _b : Object, typeof (_c = typeof OptimizedWebSocketService !== "undefined" && OptimizedWebSocketService) === "function" ? _c : Object, typeof (_d = typeof OptimizedA2AService !== "undefined" && OptimizedA2AService) === "function" ? _d : Object])
