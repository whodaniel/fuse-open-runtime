...
var _a;
import { Controller, Get, Put, Param, Query, UseGuards, UseInterceptors } from '@nestjs/common';
import { ApiTags, ApiOperation, ApiResponse, ApiBearerAuth, ApiQuery, ApiParam } from '@nestjs/swagger';
import { JwtAuthGuard } from '../modules/auth/guards/jwt-auth.guard';
import { PerformanceInterceptor } from '../interceptors/performance.interceptor';
import { MonitoringDashboardService } from './dashboard.service';
let MonitoringDashboardController = class MonitoringDashboardController {
    dashboardService;
    ...
    async getAlerts(limit = 50, status = 'active') {
...
], MonitoringDashboardController.prototype, "getDashboard", null);
__decorate([
    Get('metrics/current'),
    ApiOperation({
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], MonitoringDashboardController.prototype, "getCurrentMetrics", null);
__decorate([
    Get('metrics/history'),
    ApiOperation({
    ...
    __metadata("design:returntype", Promise)
], MonitoringDashboardController.prototype, "getMetricsHistory", null);
__decorate([
    Get('alerts'),
    ApiOperation({
    ...
    __metadata("design:returntype", Promise)
], MonitoringDashboardController.prototype, "getAlerts", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], MonitoringDashboardController.prototype, "resolveAlert", null);
MonitoringDashboardController = __decorate([
    ApiTags('Monitoring Dashboard'),
    Controller('api/monitoring'),
    UseGuards(JwtAuthGuard),
    UseInterceptors(PerformanceInterceptor),
    ApiBearerAuth(),
    __metadata("design:paramtypes", [typeof (_a = typeof MonitoringDashboardService !== "undefined" && MonitoringDashboardService) === "function" ? _a : Object])
], MonitoringDashboardController);
export { MonitoringDashboardController };
