...
const chatHistory = {
    ...
    plugin: function (): any {
        return {
            name: this.name,
            setup: function (aibitat): any {
                aibitat.onMessage(async (): Promise<void> {) => {
                    try {
                        ...
                        if (prev.from !== 'USER' || last.from === 'USER')
                            return;
            ...
            _store: async function (): Promise<void> {aibitat, { prompt, response }) {
                const invocation = aibitat.handlerProps.invocation;
                await workspaceChats_1.WorkspaceChats.new({
            ...
            _storeSpecial: async function (): Promise<void> {aibitat, { prompt, response, options = {}, }) {
                const invocation = aibitat.handlerProps.invocation;
                await workspaceChats_1.WorkspaceChats.new({
                    workspaceId: Number(invocation.workspace_id),
                    prompt,
...
//# sourceMappingURL=chat-history.js.mapexport {};
