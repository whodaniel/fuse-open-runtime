...
var __classPrivateFieldSet = (this && this.__classPrivateFieldSet) || function (receiver, state, value, kind, f): any {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return (kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;
};
var __classPrivateFieldGet = (this && this.__classPrivateFieldGet) || function (receiver, state, kind, f): any {
...
class EphemeralAgentHandler extends _1.AgentHandler {
    ...
    async createAIbitat(): Promise<void> {args = {
        handler: null,
    }) {
...
_EphemeralAgentHandler_invocationUUID = new WeakMap(), _EphemeralAgentHandler_workspace = new WeakMap(), _EphemeralAgentHandler_userId = new WeakMap(), _EphemeralAgentHandler_threadId = new WeakMap(), _EphemeralAgentHandler_sessionId = new WeakMap(), _EphemeralAgentHandler_prompt = new WeakMap(), _EphemeralAgentHandler_funcsToLoad = new WeakMap(), _EphemeralAgentHandler_instances = new WeakSet(), _EphemeralAgentHandler_chatHistory = async function _EphemeralAgentHandler_chatHistory(): Promise<void> {limit = 10) {
...
}, _EphemeralAgentHandler_getFallbackProvider = function _EphemeralAgentHandler_getFallbackProvider(): any {
    ...
    return null;
}, _EphemeralAgentHandler_fetchModel = function _EphemeralAgentHandler_fetchModel(): any {
...
}, _EphemeralAgentHandler_providerSetupAndCheck = function _EphemeralAgentHandler_providerSetupAndCheck(): any {
    ...
    this.checkSetup();
}, _EphemeralAgentHandler_attachPlugins = function _EphemeralAgentHandler_attachPlugins(args): any {
...
}, _EphemeralAgentHandler_loadAgents = async function _EphemeralAgentHandler_loadAgents(): Promise<void> {) {
...
class EphemeralEventListener extends node_events_1.default {
     ...
     * @returns {Promise<{thoughts: string[], textResponse: string}>}
     */
    async streamAgentEvents(): Promise<void> {response, uuid) {
        const onChunkHandler = (data): any => {
...
//# sourceMappingURL=ephemeral.js.mapexport {};
