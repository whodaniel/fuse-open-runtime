...
class TextProcessorNodeExecutor {
    ...
    async executeSplit(text, options): Promise<void> {
    ...
    async executeClean(text, options): Promise<void> {
    ...
    async executeCombine(text, options): Promise<void> {
...
//# sourceMappingURL=text-processor.js.mapexport {};
