    ...
    return _jsxs(FormControl, {
        ...
        children: [
            ...
            _jsx(Select, {
                ...
                children: [{ id: 'openai', name: 'OpenAI', type: 'provider' }].map((provider) => (_jsxs(MenuItem, { value: provider.id, children: [
                        provider.name,
                        provider.type === 'aggregator' && (_jsx(SettingsIcon, {
            ...
            selectedProvider && _jsx(Select, {
                ...
                children: { models: ['gpt-3.5-turbo', 'gpt-4'] }
                    ?.models.map((modelName) => (_jsx(MenuItem, { value: modelName, children: modelName }, modelName)))
            }),
            _jsx(TextField, {
                label: "API Key",
                type: "password",
