...
integration with Google Drive, allowing AI models to search, list, and read
...
Search for files in your Google Drive with powerful full-text search
capabilities.
...
Replace `path/to/gdrive-mcp-server` with the actual path to your installation
directory.
...
This MCP server is licensed under the MIT License. See the [LICENSE](LICENSE)
file for details.
