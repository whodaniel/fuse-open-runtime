...
The Google Drive MCP server provides access to Google Drive files and documents
...
2. For Google Docs, prefer reading them directly as they'll be automatically
