...
export const Horizontal = {
    ...
    render: (args) => (<Split {...args} className="w-[800px] h-[400px] border border-border rounded-md">
...
export const NestedSplit = {
    render: () => (<Split direction="horizontal" initialSizes={[30, 70]} className="w-[800px] h-[400px] border border-border rounded-md">
      <div className="w-full h-full p-4 bg-muted">
        <h3 className="text-lg font-medium">Left Panel</h3>
        <p className="text-sm text-muted-foreground mt-2">
          This is the left panel content.
