...
export const Default = {
    ...
    render: (args) => (<Accordion className="w-[400px]" {...args}>
...
export const Disabled = {
    render: () => (<Accordion type="single" defaultValue="item-1" className="w-[400px]">
      <AccordionItem value="item-1">
...
export const Controlled = {
    render: () => {
        ...
        <Accordion type="single" value={value} onValueChange={(value) => typeof value === 'string' ? setValue(value) : setValue(value[0] || '')} className="w-[400px]">
          <AccordionItem value="item-1">
            <AccordionTrigger>First item</AccordionTrigger>
            <AccordionContent>
        ...
        <div className="flex gap-2">
          <button className="px-3 py-1 text-sm border rounded-md" onClick={() => setValue('item-1')}>
            Open Item 1
          </button>
          <button className="px-3 py-1 text-sm border rounded-md" onClick={() => setValue('item-2')}>
            Open Item 2
          </button>
...
export const WithCustomChevron = {
    render: () => (<Accordion type="single" defaultValue="item-1" className="w-[400px]">
      <AccordionItem value="item-1">
        <AccordionTrigger chevron={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4">
              <path d="m6 9 6 6 6-6"/>
            </svg>}>
          Custom chevron
        </AccordionTrigger>
