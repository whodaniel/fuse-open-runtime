...
const Breadcrumb = React.forwardRef(({ className, size, separator = '/', children, ...props }, ref) => {
    return (_jsx(BreadcrumbContext.Provider, { value: {
            separator,
            size,
        }, children: _jsx("nav", { ref: ref, "aria-label": "Breadcrumb", className: cn(breadcrumbVariants({ size }), className), ...props, children: _jsx("ol", { className: "flex flex-wrap items-center", children: children }) }) }));
});
...
const BreadcrumbItem = React.forwardRef(({ className, variant, isCurrent = false, href, asChild = false, children, ...props }, ref) => {
    ...
    return (_jsx("li", { ref: ref, className: cn(breadcrumbItemVariants({ variant }), isCurrent && 'text-foreground font-medium', className), "aria-current": isCurrent ? 'page' : undefined, ...props, children: _jsx(Comp, { ...compProps, className: cn('outline-none focus:underline', isCurrent && 'cursor-default'), children: children }) }));
});
...
const BreadcrumbSeparator = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (_jsx("li", { ref: ref, role: "presentation", "aria-hidden": "true", className: cn(breadcrumbSeparatorVariants({ size }), className), ...props, children: separator }));
});
...
const BreadcrumbList = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    const itemsWithSeparators = items.reduce((acc, item, index) => {
        ...
        return [
            ...acc,
            _jsx(BreadcrumbSeparator, {}, `separator-${index}`),
            item,
        ];
    }, []);
    return (_jsx("ol", { ref: ref, className: cn('flex flex-wrap items-center', className), ...props, children: itemsWithSeparators }));
});
