...
const DefaultNode = ({ data }) => {
    return (_jsxs("div", { className: styles.defaultNode, children: [_jsxs("div", { className: styles.nodeTitle, children: [_jsx("div", { className: "p-1.5 rounded-md bg-blue-500/10 border border-blue-500/20", children: _jsx(Cpu, { className: "w-4 h-4 text-blue-400" }) }), _jsx("span", { children: data.label })] }), _jsxs("div", { className: styles.statusBadge, children: [_jsx("div", { className: `${styles.statusIndicator} ${data.status === "running" ? styles.statusRunning :
                            data.status === "error" ? styles.statusError : styles.statusIdle}` }), _jsx("span", { children: data.status || 'idle' })] }), data.metadata && (_jsx("div", { className: styles.metadataList, children: Object.entries(data.metadata).map(([key, value]) => (_jsxs("div", { className: styles.metadataItem, children: [_jsxs("span", { className: "opacity-60", children: [key, ":"] }), _jsx("span", { className: styles.metadataValue, children: value })] }, key))) }))] }));
};
const TaskNode = ({ data }) => {
    return (_jsxs("div", { className: styles.taskNode, children: [_jsxs("div", { className: styles.nodeTitle, children: [_jsx("div", { className: "p-1.5 rounded-md bg-sky-500/10 border border-sky-500/20", children: _jsx(Shield, { className: "w-4 h-4 text-sky-300" }) }), _jsx("span", { children: data.label })] }), _jsxs("div", { className: styles.statusBadge, children: [_jsx("div", { className: `${styles.statusIndicator} ${data.status === "running" ? styles.statusRunning :
                            data.status === "error" ? styles.statusError : styles.statusIdle}` }), _jsx("span", { children: data.status || 'queued' })] }), data.metadata && (_jsx("div", { className: styles.metadataList, children: Object.entries(data.metadata).map(([key, value]) => (_jsxs("div", { className: styles.metadataItem, children: [_jsxs("span", { className: "opacity-60", children: [key, ":"] }), _jsx("span", { className: styles.metadataValue, children: value })] }, key))) }))] }));
};
const AgentNode = ({ data }) => {
    return (_jsxs("div", { className: styles.agentNode, children: [_jsxs("div", { className: styles.nodeTitle, children: [_jsx("div", { className: "p-1.5 rounded-md bg-purple-500/10 border border-purple-500/20", children: _jsx(Brain, { className: "w-4 h-4 text-purple-300" }) }), _jsx("span", { children: data.label })] }), _jsxs("div", { className: styles.statusBadge, children: [_jsx("div", { className: `${styles.statusIndicator} ${data.status === "running" ? styles.statusRunning : styles.statusIdle}` }), _jsx("span", { children: data.status || 'standby' })] })] }));
};
const nodeTypes = {
    default: DefaultNode,
    task: TaskNode,
