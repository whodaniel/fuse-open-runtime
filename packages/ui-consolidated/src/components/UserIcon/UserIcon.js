...
const Robot = (props) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export default function UserIcon({ user, role = "user", className = "" }) {
    if (role === "assistant") {
        return (<div className={`w-[35px] h-[35px] flex-shrink-0 ${className}}>
        <Robot
