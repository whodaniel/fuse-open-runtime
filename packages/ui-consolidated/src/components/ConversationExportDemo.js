...
export const ConversationExportDemo = () => {
    ...
    return (<div className="max-w-xl mx-auto p-4 bg-card rounded shadow">
      <h2 className="text-lg font-semibold mb-2">Conversation Export Demo</h2>
      <textarea className="w-full h-32 p-2 border rounded mb-4 text-sm" value={conversation} onChange={e => setConversation(e.target.value)} aria-label="Conversation text"/>
...
//# sourceMappingURL=ConversationExportDemo.js.map