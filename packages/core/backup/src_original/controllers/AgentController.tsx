...
import { CognitiveCore, CognitiveResult } from '../cognitive/CognitiveCore'; // Assuming CognitiveResult type export
import { MetaLearner, LearningResult } from '../learning/MetaLearner'; // Assuming LearningResult type export
import { SocialCore, SocialResult } from '../social/SocialCore'; // Assuming SocialResult type export
import { EmergenceCore, EmergenceResult } from '../emergence/EmergenceCore'; // Assuming EmergenceResult type export // Define a more specific type for interaction data
