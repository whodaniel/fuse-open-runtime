...
var AgentOptimization = function (_a) {
    ...
    className = "space-y-6" >
        className;
    "text-lg font-medium text-gray-900" > Agent;
    Optimization < /h3>
        < p;
    ...
    onChange = { function(e) { return setConfig(function (prev) { return (__assign(__assign({}, prev), { strategy: e.target.value })); }); } };
    className = "mt-1 block w-full rounded-md border border-gray-300 px-3 py-2" >
        value;
    "balanced" > Balanced < /option>
        < option;
    value = "performance" > Performance < /option>
        < option;
    value = "efficiency" > Efficiency < /option>
        < /select>
        < /div>
        < div >
        className;
    ...
    onChange = { function(e) { return setSelectedMetric(e.target.value); } };
...
selectedMetric || !targetValue;
 >
    ...
    < div;
className = "space-y-2" >
    { config, : .metrics.map(function (metric) {
            return key = { metric };
            ...
            /span>
                < button;
            type = "button";
            onClick = { function() { return removeMetric(metric); } };
