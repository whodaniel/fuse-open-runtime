...
var AgentCreationForm = function (_a) {
    ...
    "Name";
    value = { formData, : .name };
    onChange = { function(e) { return setFormData(__assign(__assign({}, formData), { name: e.target.value })); } };
    required;
    fullWidth /  >
        className;
    "space-y-2" >
    ...
    onChange = { function(e) { return setFormData(__assign(__assign({}, formData), { description: e.target.value })); } };
    ...
    "block text-sm font-medium text-gray-700" >
        ...
        < select;
    value = { formData, : .type };
    onChange = { function(e) { return setFormData(__assign(__assign({}, formData), { type: e.target.value })); } };
    className = "w-full rounded-md border border-gray-300 px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500";
    required >
...
onChange = { function(e) { return setCapability(e.target.value); } };
