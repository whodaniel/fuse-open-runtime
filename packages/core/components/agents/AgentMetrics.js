...
var AgentMetrics = function (_a) {
    ...
    "space-y-2" >
        className;
    "text-sm font-medium text-gray-500" > Tasks;
    Completed < /h4>
        < p;
    ...
    className = "space-y-2" >
        className;
    "text-sm font-medium text-gray-500" > Average;
    Response;
    Time < /h4>
        < p;
    className = "text-2xl font-semibold text-gray-900" >
    ...
    style = {};
    {
        width: "".concat(metrics.successRate * 100, "%");
    }
} /  >
    /div>
    ...
    className;
"text-sm font-medium text-gray-500" > Error;
Rate < /h4>
    < div;
className = "flex items-center" >
    className;
...
style = {};
{
    width: "".concat(metrics.errorRate * 100, "%");
}
/>
    < /div>
    < span;
...
className = "mt-6" >
    className;
"text-sm font-medium text-gray-500" > Uptime < /h4>
    < div;
className = "mt-2 flex items-center" >
    className;
"flex-1 h-3 bg-gray-200 rounded-full overflow-hidden" >
    className;
"h-full bg-blue-500 rounded-full";
style = {};
{
    width: "".concat((metrics.uptime / 100) * 100, "%");
}
/>
    < /div>
    < span;
