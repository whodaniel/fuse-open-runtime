...
var TwoFactorAuth = function (_a) {
    ...
    onChange = { function(e) { return setFormData(__assign(__assign({}, formData), { method: e.target.value })); } } >
        value;
    "app" > Authenticator;
    App < /option>
        < option;
    ...
    id = "code";
    value = { formData, : .code };
    onChange = { function(e) { return setFormData(__assign(__assign({}, formData), { code: e.target.value })); } };
    pattern = "[0-9]*";
    maxLength = { 6:  };
    required /  >
        /div>
