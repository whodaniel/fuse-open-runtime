...
var WorkflowProvider = function (_a) {
  ...
  var _b = (0, react_1.useState)(defaultWorkflow),
    workflow = _b[0],
    setWorkflowState = _b[1];
  var _c = (0, react_1.useState)(null),
    selectedNode = _c[0],
    setSelectedNode = _c[1];
  var _d = (0, react_1.useState)(null),
    selectedEdge = _d[0],
    setSelectedEdge = _d[1];
  ...
  var addNode = (0, react_1.useCallback)(function (node) {
    setWorkflowState(function (prev) {
      return __assign(__assign({}, prev), {
        nodes: __spreadArray(__spreadArray([], prev.nodes, true), [node], false),
      });
    });
  }, []);
  var updateNode = (0, react_1.useCallback)(function (nodeId, data) {
    setWorkflowState(function (prev) {
      return __assign(__assign({}, prev), {
        nodes: prev.nodes.map(function (node) {
  ...
  var removeNode = (0, react_1.useCallback)(function (nodeId) {
    setWorkflowState(function (prev) {
      return {
        edges: prev.edges.filter(function (edge) {
          return edge.source !== nodeId && edge.target !== nodeId;
        }),
        nodes: prev.nodes.filter(function (node) {
  ...
  var addEdge = (0, react_1.useCallback)(function (edge) {
    setWorkflowState(function (prev) {
      return __assign(__assign({}, prev), {
        edges: __spreadArray(__spreadArray([], prev.edges, true), [edge], false),
      });
    });
  }, []);
  var updateEdge = (0, react_1.useCallback)(function (edgeId, data) {
    setWorkflowState(function (prev) {
      return __assign(__assign({}, prev), {
        edges: prev.edges.map(function (edge) {
