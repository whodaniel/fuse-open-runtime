...
import { UnifiedBridge, Priority } from '../config/redis_config.js';
import { StateTransferError } from '../utils/exceptions.js';
...
export class StateManager {
    ...
    constructor(private readonly bridge: UnifiedBridge) {
        ...
        try {
            const state   = `agent this.bridge.redis.pipeline()): void {
                return null;
            }
            ...
            if(state.version !== version {
                ...
                throw new StateTransferError('Failed to send state transfer message')): void {
