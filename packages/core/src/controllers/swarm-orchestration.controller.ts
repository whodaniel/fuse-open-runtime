...
export class SwarmOrchestrationController {
  ...
  @Roles('AGENCY_ADMIN', 'AGENCY_MANAGER')
  async removeAgentFromSwarm(): any {
  ...
  @Roles('AGENCY_ADMIN')
  async optimizeCoordination(): any {
