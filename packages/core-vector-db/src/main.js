...
async function bootstrap() {
    const logger = new common_1.Logger('VectorDBMicroservice');
    // Configuration from environment variables
    const grpcUrl = process.env.GRPC_URL || '0.0.0.0:50051';
    const protoPath = process.env.PROTO_PATH || (0, path_1.join)(__dirname, '../../../proto-definitions/proto/vector_store.proto');
    logger.log(`Starting Vector Database gRPC microservice on ${grpcUrl});`, logger.log(`Using proto file: ${protoPath}` `);
