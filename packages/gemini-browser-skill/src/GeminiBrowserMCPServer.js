...
const GeminiBrowserAutomation_1 = require("./GeminiBrowserAutomation");
class GeminiBrowserMCPServer {
    ...
    async handlePrompt(args) {
        ...
        const response = await GeminiBrowserAutomation_1.geminiBrowser.prompt(request);
        if (!response.success) {
            return {
                content: [
                    {
     ...
     */
    handleStatus() {
        const isReady = GeminiBrowserAutomation_1.geminiBrowser.isReady();
        return {
            content: [
                {
                    type: 'text',
    ...
    async handleInitialize() {
        const success = await GeminiBrowserAutomation_1.geminiBrowser.initialize();
        return {
            content: [
                {
                    type: 'text',
     ...
     */
    async handleClose() {
        await GeminiBrowserAutomation_1.geminiBrowser.close();
        return {
            content: [
                {
                    type: 'text',
