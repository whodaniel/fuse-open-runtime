...
class OrchestratorAgentInput(AgentInputBase):
...
class OrchestratorAgentOutput(AgentOutputBase):
...
class OrchestratorAgentMetadata(AgentMetadataBase):
    ...
    input_model: str = "OrchestratorAgentInput"
    output_model: str = "OrchestratorAgentOutput"
