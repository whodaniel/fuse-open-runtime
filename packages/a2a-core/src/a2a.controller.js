...
let A2AController = A2AController_1 = class A2AController {
    a2aService;
    logger = new common_1.Logger(A2AController_1.name);
    ...
    async startConversation(body) {
        const conversationId = await this.a2aService.startConversation(body.initiator, body.participants, body.topic);
...
exports.A2AController = A2AController = A2AController_1 = __decorate([
    ...
    __metadata("design:paramtypes", [a2a_service_1.A2AService])
], A2AController);
