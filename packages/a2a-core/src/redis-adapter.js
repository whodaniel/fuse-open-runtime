...
import { A2AConnectionError, A2AError, A2AMessageSchema, A2AMessageType, A2APriority, A2ATimeoutError, A2AValidationError, AgentHeartbeatSchema, AgentRegistrationSchema, AgentStatus, ConversationSchema, } from './types';
let A2ARedisAdapter = A2ARedisAdapter_1 = class A2ARedisAdapter extends EventEmitter {
    constructor(config, redisService) {
        ...
        Object.defineProperty(this, "logger", {
            ...
            configurable: true,
            writable: true,
            value: new Logger(A2ARedisAdapter_1.name)
        });
        ...
        Object.defineProperty(this, "requestTimeouts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
