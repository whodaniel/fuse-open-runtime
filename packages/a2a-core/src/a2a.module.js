...
const a2a_service_1 = require("./a2a.service");
    ...
    static forRoot(config) {
        return {
            ...
            providers: [
                ...
                {
                    provide: redis_adapter_1.A2ARedisAdapter,
                    useFactory: (config) => new redis_adapter_1.A2ARedisAdapter(config),
                    inject: ['A2A_CONFIG']
                },
                {
                    provide: websocket_adapter_1.A2AWebSocketAdapter,
                    useFactory: (config, redisAdapter) => new websocket_adapter_1.A2AWebSocketAdapter(config, redisAdapter),
                    inject: ['A2A_CONFIG', redis_adapter_1.A2ARedisAdapter]
                },
                {
                    provide: a2a_service_1.A2AService,
                    useFactory: (config, redisAdapter, websocketAdapter) => new a2a_service_1.A2AService(config, redisAdapter, websocketAdapter),
                    inject: ['A2A_CONFIG', redis_adapter_1.A2ARedisAdapter, websocket_adapter_1.A2AWebSocketAdapter]
                }
            ],
            exports: [a2a_service_1.A2AService, redis_adapter_1.A2ARedisAdapter, websocket_adapter_1.A2AWebSocketAdapter, 'A2A_CONFIG'],
            global: true
        };
    }
