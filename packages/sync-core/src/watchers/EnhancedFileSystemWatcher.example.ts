...
export async function setupEnhancedFileWatcher() {
  ...
  const dbService = new SyncDatabaseService(/* DatabaseService instance */);
  ...
  const config: WatcherConfig = {
    paths: ['./apps/browser-hub/**/*', './packages/*/src/**/*', './scripts/**/*'],
    ignored: ['node_modules/**', '.git/**', 'dist/**', 'build/**', '*.tmp', '*.temp'],
    depth: 10,
    debounceMs: 200,
...
export { EnhancedFileSystemWatcher, type FileChangeEvent, type WatcherConfig };
