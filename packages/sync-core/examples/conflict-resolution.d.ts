...
export declare class DocumentSyncService {
  ...
  getConflictStats(tenantId: string): Promise<{
    ...
    pendingReviews: {
      ...
      conflictType: string;
      localVersion: import('@the-new-fuse/database/generated/db/runtime/library').JsonValue;
      remoteVersion: import('@the-new-fuse/database/generated/db/runtime/library').JsonValue;
      resourceType: string;
      resourceId: string;
      resolvedAt: Date | null;
      resolvedBy: string | null;
      resolution:
        | import('@the-new-fuse/database/generated/db/runtime/library').JsonValue
        | null;
    }[];
  }>;
}
