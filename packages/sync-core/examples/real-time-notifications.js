...
let RealTimeNotificationService = class RealTimeNotificationService {
    ...
    async sendNotification(notification) {
        ...
        if (notification.userId) {
            await this.syncOrchestrator.syncTenantData(notification.tenantId, 'notification', fullNotification);
        }
...
RealTimeNotificationService = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [SyncOrchestrator, typeof (_a = typeof NotificationService !== "undefined" && NotificationService) === "function" ? _a : Object])
