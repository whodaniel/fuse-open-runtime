...
This package contains the core smart contracts for The New Fuse decentralized agent ecosystem, enabling on-chain identity, economic primitives, and governance for AI agents.
...
### Purpose
The AgentNFTFactory serves as the exclusive minting authority for all Agent NFTs in The New Fuse ecosystem. It bridges off-chain agent registration (via MasterAgentRegistry) with immutable on-chain identity, enabling agents to own assets, participate in governance, and engage in economic activities.
...
### Purpose
Enables fractional ownership of high-value Agent NFTs through ERC-20 share tokens, allowing multiple parties to own portions of a single agent and receive proportional revenue.
...
### Purpose
Handles multi-generational royalty distribution across agent lineage hierarchies, ensuring fair compensation for all agents in a derivation chain.

### Key Features
- **Multi-Generation Support**: Up to 5 generations in lineage
- **Configurable Distribution**: Default percentages (50%, 25%, 12.5%, 6.25%, 6.25%)
...
### Purpose
Decentralized marketplace for renting Agent NFTs, enabling agent-as-a-service business models with flexible pricing and secure escrow.
...
### Purpose
Tracks lineage and relationships between Agent NFTs for multi-generational royalties, attribution, and collaboration verification.
