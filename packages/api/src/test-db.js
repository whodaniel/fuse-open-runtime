...
import { AgentStatus as PrismaAgentStatus } from '@the-new-fuse/database/generated/prisma';
async function testDatabaseConnection() {
    ...
    try {
        ...
        const agent = await prismaService.agent.create({
            data: {
                name: 'Test Agent',
                type: 'GENERIC', // Use a valid enum value from the schema
                description: 'Test agent description',
                status: PrismaAgentStatus.INACTIVE,
                userId: 'test-user-id',
