...
async function loadWorkflowState(workflowId: string): Promise<WorkflowState> {
  try {
...
async function saveWorkflowState(workflowId: string, state: WorkflowState): Promise<void> {
  try {
