...
import { Message, MessageType, UUID } from '@packages/types';
  ...
  async processMessage(message: unknown): Promise<void> {
    ...
    try {
      ...
      switch (typedMessage.type) {
        ...
        this.logger.error(`Unhandled error processing message ${typedMessage.id} (Type: ${typedMessage.type}): ${error.message}`, error);
        ...
        await this.alertService.error(
            ...
            { error: error.message, messageType: typedMessage.type }
        );
    }
  }
