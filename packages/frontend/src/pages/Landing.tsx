...
export const Landing: React.FC = () => {
  return (
    <Box minH="100vh" bgGradient="linear(to-b, gray.50, white)">
      <Box as="nav" maxW="7xl" mx="auto" px={{ base: 4, sm: 6, lg: 8 }} py={6}>
      ...
      <Box as="main" maxW="7xl" mx="auto" px={{ base: 4, sm: 6, lg: 8 }} py={{ base: 16, sm: 24 }}>
      ...
      <Box as="footer" bg="gray.50" borderTop="1px" borderColor="gray.200">
