...
export class MetricsCollector {
  ...
  private infrastructureMetrics: Map<string, InfrastructureMetrics> = new Map();
  ...
  private classifyDeploymentFrequency(frequency: number): string {
  ...
  private classifyLeadTime(leadTime: number): string {
  ...
  private classifyMTTR(mttr: number): string {
  ...
  private isMetricsFresh(lastUpdated: Date): boolean {
