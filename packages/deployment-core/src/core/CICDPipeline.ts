 ...
 */
export class CICDPipeline extends EventEmitter implements ICICDPipeline {
  ...
  private runningPipelines: Map<string, PipelineExecution> = new Map();
   ...
   */
  async triggerBuild(trigger: BuildTrigger): Promise<BuildResult> {
