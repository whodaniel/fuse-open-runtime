import { BuildTrigger, BuildResult, PipelineDefinition, PipelineResult, DeploymentConfig, DeploymentResult, RollbackResult, PipelineStatus, PipelineConfig } from '../types/pipeline';
/**
