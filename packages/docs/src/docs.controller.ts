...
export class DocsController {
  constructor(private readonly docGeneratorService: ApiDocGeneratorService) {}

  // Public documentation endpoints (no auth required)
  @Get('openapi.json')
  @ApiExcludeEndpoint()
  @Header('Content-Type', 'application/json')
  async getOpenAPISpec(@Res() res: Response): Promise<void> {
    try {
  ...
  async getSwaggerUI(@Res() res: Response): Promise<void> {
    const swaggerHTML = `
<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  private convertToOpenAPI(documentation: ApiDocumentation): any {
    return {
      openapi: '3.0.3',
...
**Generated:** ${documentation.info.generatedAt}
...
<body>
  ...
  private convertToPostman(documentation: ApiDocumentation): any {
    return {
      info: {
