...
- **[Complete API Guide](COMPLETE-API-GUIDE.md)** - Comprehensive API
  documentation including all endpoints, authentication, WebSocket protocols,
  middleware, and security guidelines

## Architecture

This section consolidates all API-related documentation into a single
...
- **Agency APIs** - Multi-tenant agency management and registrations
- **Agent Registry** - Registration, onboarding, reporting, integrity checks
- **WebSocket Protocol** - Real-time communication, message formats, error
  handling
...
Individual API documentation files have been archived in `_archive/` for
reference:
