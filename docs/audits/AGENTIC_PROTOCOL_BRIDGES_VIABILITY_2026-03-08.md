...
| AG2 bridge                                | `packages/integrations/ag2/ag2-integration/src/ag2-bridge.tsx`       | Low              | Low       | File appears transpiled/mixed artifact and not clearly wired into active runtime.     |
