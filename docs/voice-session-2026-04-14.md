...
- **Files involved**:
  - `/Users/danielgoldberg/bin/voice_server.py` (lines 471-477:
    `looks_like_ai_echo()`)
  - `/Users/danielgoldberg/bin/voice-response-audio-watch.py` (echo suppression
    logic)
- **How it works**:
...
- **Modified**: `/Users/danielgoldberg/bin/voice_server.py` (lines 867-875)
- **Behavior**:
