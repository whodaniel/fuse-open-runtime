...
This document outlines how to set up and use the Supabase integration for The
New Fuse framework.
...
2.  **Add environment variables:**
    ...
    Add the following variables to your `.env.development` and `.env.example`
    files:
...
The `SupabaseService` provides a set of methods for interacting with your
Supabase project. You can use it to perform database operations and subscribe to
real-time changes.
