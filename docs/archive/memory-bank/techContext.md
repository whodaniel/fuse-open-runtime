...
*   **Dependencies:** Key libraries include NestJS, React, Material UI, Drizzle, Redis client, `ws`. (A full dependency list would require inspecting `package.json` files). Includes integration with Google's ADK via a Python Bridge.
*   **Tool Usage Patterns:**
