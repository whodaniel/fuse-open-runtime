...
const config = {
  ...
  searchDirs: [
    ...
    'packages/features',
    'packages/ui-consolidated/src/components',
...
Sunset note (2026-05-17): `packages/layout` was removed from the active
workspace. Use `packages/ui-consolidated/src/components` as the layout discovery
source.
