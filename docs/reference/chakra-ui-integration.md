...
The following Chakra UI packages have been successfully integrated with React
18.2.0:
...
2. No additional configuration is required beyond the standard Chakra UI
   provider setup
3. The packages are compatible with Vite as the build tool

## Compatibility Notes

- All @chakra-ui packages are using version 2.x.x which is fully compatible with
  React 18
- The emotion packages are maintained at version 11.x.x for optimal
  compatibility
