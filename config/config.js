...
class Config {
  constructor() {
    ...
    this.SQLALCHEMY_DATABASE_URI = process.env.DATABASE_URL || 'sqlite:///instance/dashboard.db';
    ...
    if (!process.env.ENCRYPTION_KEY) {
      ...
      console.warn(
        'WARNING: Using auto-generated ENCRYPTION_KEY for development. Set ENCRYPTION_KEY environment variable for production.'
      );
    } else {
      this.ENCRYPTION_KEY = process.env.ENCRYPTION_KEY;
    }
    this.ACCESS_TOKEN_EXPIRE_MINUTES = parseInt(
