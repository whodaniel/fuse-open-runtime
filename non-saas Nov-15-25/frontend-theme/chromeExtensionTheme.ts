// Quarantined Chrome Extension theme (non‑SAAS)
// Original content moved out of SAAS due to corruption and non‑SAAS scope.
export const chromeExtensionLightTheme = {} as any;
