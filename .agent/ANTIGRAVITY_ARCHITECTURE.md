...
| `database-architect`    | Schema, SQL              | database-design, drizzle-expert                       |
...
Domain-specific knowledge modules. Skills are loaded on-demand based on task
context.
...
| Database | `database-architect`  | database-design, drizzle-expert        |
