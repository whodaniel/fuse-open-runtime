...
**Screenshot:** (N/A in headless mode) {screenshot_path}

**Console Errors** (if applicable, N/A in headless mode):

```
{console_error_output}
```

**Notes on headless mode:** In headless mode, screenshots and console errors are
not captured. These sections are primarily for browser-based testing.
