...
A simple static landing page for a fictional SaaS product. Tests Loki Mode's
frontend and marketing agent capabilities.
...
**Purpose:** Tests frontend agent, marketing agent (copy), and design patterns
