...
A minimal todo application for testing Loki Mode with a simple, well-defined
scope.
...
**Purpose:** This PRD is intentionally simple to allow quick testing of Loki
Mode's core functionality without waiting for complex builds or deployments.
