...
> Animation principles and timing psychology - learn to decide, not copy. **No
> fixed durations to memorize - understand what affects timing.**
...
2. **Match the action** (press = `scale(0.95)`, hover =
   `translateY(-4px) + glow`)
...
> **Remember**: Animation is communication. Every motion should have meaning and
