...
"List all console warnings and errors"
"Evaluate this JavaScript: window.myGlobalVar"
```

### Measure Performance

```markdown
"Run a performance trace and show me the Core Web Vitals"
"Why is this page loading so slowly?"
"Test page speed with slow 3G network"
```
...
"Click the login button and verify success"
