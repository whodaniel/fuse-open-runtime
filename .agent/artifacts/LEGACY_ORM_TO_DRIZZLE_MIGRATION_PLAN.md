...
imports `DatabaseService` from database.
...
1. Replace all DatabaseService imports with Drizzle repositories
...
- Some tests use mock DatabaseService - need to update mocks
