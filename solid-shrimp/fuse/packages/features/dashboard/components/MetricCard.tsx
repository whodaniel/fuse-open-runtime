...
var MetricCard = function (): JSX.Element _a) {
    var metric = _a.metric, _b = _a.className, className = _b === void 0 ? '' : _b;
    var getChangeColor = function (): JSX.Element trend) {
        switch (trend) {
            case 'up':
    ...
    var getBackgroundColor = function (): JSX.Element color) {
        switch (color) {
            case 'blue':
                return 'bg-blue-50';
            case 'green':
    ...
    var getIconColor = function (): JSX.Element color) {
        switch (color) {
            case 'blue':
