...
const UNKNOWN_NODE_TYPE = 'UNKNOWN_NODE_TYPE';
const NODE_VALIDATION_ERROR = 'NODE_VALIDATION_ERROR';
const MISSING_SOURCE_NODE = 'MISSING_SOURCE_NODE';
const MISSING_TARGET_NODE = 'MISSING_TARGET_NODE';
const CYCLIC_WORKFLOW = 'CYCLIC_WORKFLOW';
...
class WorkflowValidator {
    ...
    hasCycles(nodes, edges) {
        ...
        const hasCycleFromNode = (nodeId): any => {
