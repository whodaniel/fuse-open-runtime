...
exports.ModelSelectorWebView = void 0;
 ...
 */
class ModelSelectorWebView {
    constructor(context, llmManager) {
        this.disposables = [];
        this.context = context;
        this.llmManager = llmManager;
    }
    static getInstance(context, llmManager) {
    ...
    show() {
        ...
        this.panel = vscode.window.createWebviewPanel('modelSelector', 'AI Model Selection', vscode.ViewColumn.Beside, {
            enableScripts: true,
            localResourceRoots: [
...
exports.ModelSelectorWebView = ModelSelectorWebView;
//# sourceMappingURL=model-selector-webview.js.map