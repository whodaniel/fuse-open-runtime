...
exports.MasterCommandCenter = void 0;
exports.registerMasterCommandCenter = registerMasterCommandCenter;
...
class MasterCommandCenter {
    ...
    async show() {
        ...
        this.panel = vscode.window.createWebviewPanel('masterCommandCenter', 'The New Fuse Command Center', vscode.ViewColumn.One, {
            enableScripts: true,
     ...
     */
    async executeVSCodeCommand(commandId, args) {
        try {
...
exports.MasterCommandCenter = MasterCommandCenter;
/**
 * Register the Master Command Center command
 * @param context VS Code extension context
 */
function registerMasterCommandCenter(context) {
...
//# sourceMappingURL=master-command-center.js.map