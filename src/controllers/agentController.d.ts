...
export declare class AgentController {
    ...
    createAgent(data: CreateAgentDto, req: Request): Promise<import("@the-new-fuse/types").Agent>;
    getAgentById(id: string, req: Request): Promise<any>;
    updateAgent(id: string, updates: UpdateAgentDto, req: Request): Promise<import("@the-new-fuse/types").Agent>;
