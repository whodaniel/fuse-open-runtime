...
let AgentDiscoveryService = AgentDiscoveryService_1 = class AgentDiscoveryService {
    ...
    mcpBroker;
    eventEmitter;
    logger = new Logger(AgentDiscoveryService_1.name);
...
AgentDiscoveryService = AgentDiscoveryService_1 = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [typeof (_a = typeof PrismaService !== "undefined" && PrismaService) === "function" ? _a : Object, MCPBrokerService,
        EventEmitter2])
