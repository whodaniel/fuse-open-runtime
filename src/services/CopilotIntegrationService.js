...
let CopilotIntegrationService = CopilotIntegrationService_1 = class CopilotIntegrationService extends EventEmitter2 {
    webSocketService;
    logger = new Logger(CopilotIntegrationService_1.name);
...
CopilotIntegrationService = CopilotIntegrationService_1 = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [typeof (_a = typeof WebSocketService !== "undefined" && WebSocketService) === "function" ? _a : Object, Object])
], CopilotIntegrationService);
export { CopilotIntegrationService };
