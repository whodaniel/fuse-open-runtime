...
export class ValidatorFactory {
    private static validators = new Map<string, ValidationStrategy<unknown>>();

    static register<T>(key: string, validator: ValidationStrategy<T>): void {
        this.validators.set(key, validator as ValidationStrategy<unknown>);
    }
...
export class DataValidation<T> {
    private readonly strategy: ValidationStrategy<T>;
