...
let AgentMonitoringService = AgentMonitoringService_1 = class AgentMonitoringService {
    ...
    eventEmitter;
    logger = new Logger(AgentMonitoringService_1.name);
...
AgentMonitoringService = AgentMonitoringService_1 = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [ConsolidatedMonitoringService,
        EventEmitter2])
], AgentMonitoringService);
export { AgentMonitoringService };
