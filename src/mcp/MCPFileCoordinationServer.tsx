...
import { MCPServer, MCPToolParams, MCPServerOptions } from './types.js';
 ...
 */
@Injectable()
export class MCPFileCoordinationServer extends MCPServer {
  protected readonly logger = new Logger(MCPFileCoordinationServer.name);
  ...
  async updateConfiguration(params: { config: any }): Promise<any> {
    try {
  ...
  async getSession(params: { sessionId: string }): Promise<any> {
    try {
  ...
  async getSessionHistory(params: { page?: number; limit?: number; status?: string; agentId?: string }): Promise<any> {
    try {
  ...
  async unregisterParticipant(params: { agentId: string }): Promise<any> {
    try {
  ...
  async prepareFileCreation(params: { filePath: string; fileType: string; context?: any }): Promise<any> {
    try {
  ...
  async getSystemHealth(): Promise<any> {
    try {
      ...
      return {
        overall: 'unhealthy',
        components: {
          fileCoordinationService: { status: 'error', message: (error as Error).message }
        }
      };
    }
  }
  ...
  async sendCoordinationMessage(params: { 
    ...
    try {
      return await this.coordinationService.sendCoordinationMessage(
        params.sessionId,
        params.message,
        params.senderId,
        params.messageType || 'info'
      );
    } catch (error) {
  ...
  async getCoordinationMessages(params: { sessionId: string; limit?: number }): Promise<any> {
    try {
      return await this.coordinationService.getCoordinationMessages(
        params.sessionId,
        params.limit || 50
      );
    } catch (error) {
  ...
  async getTemplatesForFile(params: { fileExtension: string; context?: any }): Promise<any> {
    try {
      return await this.coordinationService.getTemplatesForFile(
  ...
  async analyzeFileContext(params: { filePath: string; analyzeDepth?: number }): Promise<any> {
    try {
      return await this.coordinationService.analyzeFileContext(
        params.filePath,
        params.analyzeDepth || 2
      );
    } catch (error) {
  ...
  async simulateCoordination(params: { filePath: string; participants?: string[] }): Promise<any> {
    try {
      return await this.coordinationService.simulateCoordination(
        params.filePath,
        params.participants
      );
    } catch (error) {
  ...
  async optimizeParticipantOrder(params: { participants: string[]; fileContext?: any }): Promise<any> {
    try {
      return await this.coordinationService.optimizeParticipantOrder(
        params.participants,
        params.fileContext
      );
    } catch (error) {
