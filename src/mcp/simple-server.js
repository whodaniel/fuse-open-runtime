...
- Features: Basic tool support, message routing - Timestamp: ${new Date().toISOString()}`,
                            },
                        ],
                    };
                case 'send_message':
                ...
                case 'tnf://system/status':
                    return {
                        contents: [
                            {
                                uri,
                                mimeType: 'text/plain', text: `TNF Platform System Status
========================
Status: Operational
                ...
                case 'tnf://system/logs':
                    return {
                        contents: [
                            {
                                uri,
                                mimeType: 'text/plain', text: `TNF Platform Recent Logs
=========================
...
// Start the server if (import.meta.url === `file://${process.argv[1]}`) {
