...
export class MCPRAGServer {
  private readonly logger = new Logger(MCPRAGServer.name);

  constructor(private readonly ragClient: MCPRAGClientService) {}
    ...
    try {
      switch (name) {
        case 'crawl_vscode_docs':
          return await this.ragClient.crawlVSCodeDocs(
            arguments_.url,
            arguments_.max_depth,
            arguments_.max_pages
          );

        case 'crawl_copilot_docs':
          return await this.ragClient.crawlCopilotDocs(
            arguments_.url,
            arguments_.max_depth,
            arguments_.max_pages
          );
        ...
        case 'crawl_typescript_docs':
          return await this.ragClient.crawlTypeScriptDocs(
            arguments_.url,
            arguments_.max_depth,
            arguments_.max_pages
          );
        ...
        case 'crawl_nestjs_docs':
          return await this.ragClient.crawlNestJSDocs(
            arguments_.url,
            arguments_.max_depth,
            arguments_.max_pages
          );
        ...
        case 'perform_rag_query':
          return await this.ragClient.performRAGQuery(
            arguments_.query,
            arguments_.collection_name,
            arguments_.max_results,
            arguments_.include_code
          );

        case 'search_code_examples':
          return await this.ragClient.searchCodeExamples(
            arguments_.query,
            arguments_.language,
            arguments_.framework,
            arguments_.max_results
          );

        case 'search_vscode_api':
          return await this.ragClient.searchVSCodeAPI(
            arguments_.api_name,
            arguments_.include_examples,
            arguments_.max_results
          );

        case 'search_copilot_docs':
          return await this.ragClient.searchCopilotDocs(
            arguments_.topic,
            arguments_.include_examples,
            arguments_.max_results
          );
