---
description:
  Update Clawdbot from upstream when branch has diverged (ahead/behind)
---

# Clawdbot Upstream Sync Workflow

Use this workflow when your fork has diverged from upstream (e.g., "18 commits
ahead, 29 commits behind").
...
**Important:** Always wait for the Telegram verification message before
proceeding. If the agent doesn't respond, troubleshoot the gateway or model
...
Common issue: `fetch.preconnect` type mismatch. Fix by using `FetchLike` type
...
**Symptoms:** Build fails with deprecation warnings about `FileManager.default`
