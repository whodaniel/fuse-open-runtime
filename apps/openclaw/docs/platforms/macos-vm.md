---
summary:
  'Run OpenClaw in a sandboxed macOS VM (local or hosted) when you need
  isolation or iMessage'
read_when:
...
- **Hybrid:** keep the Gateway on a cheap VPS, and connect your Mac as a
  **node** when you need browser/UI automation. See [Nodes](/nodes) and
...
Follow the onboarding prompts to set up your model provider (Anthropic, OpenAI,
etc.).
...
[BlueBubbles](https://bluebubbles.app) to add iMessage to OpenClaw.
