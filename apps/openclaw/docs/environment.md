...
OpenClaw pulls environment variables from multiple sources. The rule is **never
...
You can reference env vars directly in config string values using `${VAR_NAME}`
syntax:
