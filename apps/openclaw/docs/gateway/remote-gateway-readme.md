...
OpenClaw.app uses SSH tunneling to connect to a remote gateway. This guide shows
...
To have the SSH tunnel start automatically when you log in, create a Launch
Agent.
...
OpenClaw.app connects to `ws://127.0.0.1:18789` on your client machine. The SSH
