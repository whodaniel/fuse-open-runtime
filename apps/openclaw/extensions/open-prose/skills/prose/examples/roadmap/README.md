...
These examples demonstrate **planned** OpenProse syntax that is **not yet
implemented**.

They are included to show the direction of the language and gather feedback on
the design.
...
These files will not work with the current interpreter. They are for reference
only.
