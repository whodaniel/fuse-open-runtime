...
> Use at your own risk. This is an unofficial integration.
...
See [zca-cli](https://zca-cli.dev) for manual download (binaries for
macOS/Linux/Windows) or building from source.
