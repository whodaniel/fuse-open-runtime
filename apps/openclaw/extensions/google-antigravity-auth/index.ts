...
const CLAUDE_MODEL = 'google-antigravity/claude-opus-4-5-thinking';
const GEMINI_PRO_MODEL = 'google-antigravity/gemini-3-pro';
const GEMINI_FLASH_MODEL = 'google-antigravity/gemini-3-flash';
