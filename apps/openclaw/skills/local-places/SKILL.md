...
name: local-places
description:
  Search for places (restaurants, cafes, etc.) via Google Places API proxy on
  localhost.
...
Search for nearby places using a local Google Places API proxy. Two-step flow:
resolve location first, then search.
