...
- daily[]: date, inputTokens, outputTokens, cacheReadTokens,
  cacheCreationTokens, totalTokens, totalCost, modelsUsed, modelBreakdowns[]
- modelBreakdowns[]: modelName, cost
- totals: totalInputTokens, totalOutputTokens, cacheReadTokens,
...
- Cost usage is local-only. It reads JSONL logs under:
  ...
  - Claude: ~/.config/claude/projects/**/\*.jsonl or
