...
Himalaya uses MML for composing emails. MML is a simple XML-based syntax that
compiles to MIME messages.

## Basic Message Structure

An email message is a list of **headers** followed by a **body**, separated by a
blank line:
...
- Use `himalaya message export --full` to inspect the raw MIME structure of
  received emails.
