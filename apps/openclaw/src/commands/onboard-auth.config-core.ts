...
export function applySambanovaProviderConfig(cfg: OpenClawConfig): OpenClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
  models[SAMBANOVA_DEFAULT_MODEL_REF] = {
    ...models[SAMBANOVA_DEFAULT_MODEL_REF],
    alias: models[SAMBANOVA_DEFAULT_MODEL_REF]?.alias ?? 'SambaNova',
  };
...
export function applyTogetherProviderConfig(cfg: OpenClawConfig): OpenClawConfig {
  ...
  models[TOGETHER_DEFAULT_MODEL_REF] = {
    ...models[TOGETHER_DEFAULT_MODEL_REF],
    alias: models[TOGETHER_DEFAULT_MODEL_REF]?.alias ?? 'Together',
  };
      ...
      defaults: {
        ...
        model: {
          ...(existingModel && 'fallbacks' in (existingModel as Record<string, unknown>)
            ...
            : undefined),
          primary: SAMBANOVA_DEFAULT_MODEL_REF,
        },
      },
    },
  };
