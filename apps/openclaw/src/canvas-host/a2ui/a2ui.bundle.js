 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ function c$6({ context: c, subscribe: e }) {
  return (o, n) => {
    'object' == typeof n
...
const r$11 = (t) => new n$11('string' == typeof t ? t : t + '', void 0, s$5),
  i$8 = (t, ...e) => {
    const o =
      1 === t.length
        ? t[0]
...
const t$4 = globalThis,
  i$6 = (t) => t,
  s$4 = t$4.trustedTypes,
  e$9 = s$4 ? s$4.createPolicy('lit-html', { createHTML: (t) => t }) : void 0,
  h$5 = '$lit$',
...
((i$5._$litElement$ = !0),
  (i$5['finalized'] = !0),
  s$3.litElementHydrateSupport?.({ LitElement: i$5 }));
const o$11 = s$3.litElementPolyfillSupport;
o$11?.({ LitElement: i$5 });
const n$8 = {
  _$AK: (t, e, r) => {
    t._$AK(e, r);
...
(s$3.litElementVersions ??= []).push('4.2.2');
 ...
 */ const { I: t$2 } = j$1,
  i$3 = (o) => o,
  n$7 = (o) => null === o || ('object' != typeof o && 'function' != typeof o),
  e$7 = {
    HTML: 1,
    SVG: 2,
    MATHML: 3,
  ...
  c$2 = (o) => void 0 !== o?._$litDirective$,
  f$1 = (o) => o?._$litDirective$,
  r$8 = (o) => void 0 === o.strings,
  s$2 = () => document.createComment(''),
  v = (o, n, e) => {
    const l = o._$AA.parentNode,
      d = void 0 === n ? o._$AB : n._$AA;
    if (void 0 === e) {
      const i = l.insertBefore(s$2(), d),
        n = l.insertBefore(s$2(), d);
      ...
      if (t !== d || c) {
        let o = e._$AA;
        for (; o !== t; ) {
          const t = i$3(o).nextSibling;
          (i$3(l).insertBefore(o, d), (o = t));
        }
      }
    }
    return e;
      ...
      update(e, [r]) {
        ...
        for (const t in r) {
          ...
          if (null != e) {
            ...
            t.includes('-') || r
              ? s.setProperty(t, r ? e.slice(0, -11) : e, r ? n$4 : '')
              : (s[t] = e);
          }
        }
        return E;
...
const s$1 = new Signal.subtle.Watcher(() => {
  ...
  e$2 = new FinalizationRegistry((i) => {
...
function h$2(i) {
  void 0 !== this._$AN ? (o$5(this), (this._$AM = i), r$3(this)) : (this._$AM = i);
}
function n$2(i, t = !1, e = 0) {
  ...
  if (void 0 !== h && 0 !== h.size)
    if (t)
      if (Array.isArray(r)) for (let i = e; i < r.length; i++) (s(r[i], !1), o$5(r[i]));
      else null != r && (s(r, !1), o$5(r));
    else s(this, i);
}
const c = (i) => {
  i.type == t$3.CHILD && ((i._$AP ??= n$2), (i._$AQ ??= h$2));
};
 ...
 */
let o$4 = !1;
const n$1 = new Signal.subtle.Watcher(async () => {
  o$4 ||
    ((o$4 = !0),
    queueMicrotask(() => {
      o$4 = !1;
      for (const i of n$1.getPending()) i.get();
      n$1.watch();
    }));
});
...
let Root = (() => {
  ...
  var Root = class extends _classSuper {
    ...
    static {
      ...
      _theme_decorators = [c$6({ context: themeContext })];
    ...
    renderComponentTree(components) {
      ...
      return b` ${o$2(components, (component) => {
...
let Audio = (() => {
  ...
  var Audio = class extends _classSuper {
    ...
    render() {
      ...
      style=${this.theme.additionalStyles?.AudioPlayer ? o$7(this.theme.additionalStyles?.AudioPlayer) : A}
    >
      ${this.#renderAudio()}
    </section>`;
    }
...
let Button = (() => {
  ...
  var Button = class extends _classSuper {
    ...
    render() {
      ...
      style=${this.theme.additionalStyles?.Button ? o$7(this.theme.additionalStyles?.Button) : A}
      @click=${() => {
        if (!this.action) {
          return;
        }
...
let Card = (() => {
  ...
  var Card = class extends _classSuper {
    ...
    render() {
      ...
      style=${this.theme.additionalStyles?.Card ? o$7(this.theme.additionalStyles?.Card) : A}
    >
      <slot></slot>
    </section>`;
    }
...
let Checkbox = (() => {
  ...
  var Checkbox = class extends _classSuper {
    ...
    #renderField(value) {
      ...
      style=${this.theme.additionalStyles?.CheckBox ? o$7(this.theme.additionalStyles?.CheckBox) : A}
    >
      <input
...
let Column = (() => {
  ...
  var Column = class extends _classSuper {
    ...
    render() {
      ...
      style=${this.theme.additionalStyles?.Column ? o$7(this.theme.additionalStyles?.Column) : A}
    >
      <slot></slot>
    </section>`;
    }
...
let DateTimeInput = (() => {
  ...
  var DateTimeInput = class extends _classSuper {
    ...
    #renderField(value) {
      return b`<section class=${e$3(this.theme.components.DateTimeInput.container)}>
      <label for="data" class=${e$3(this.theme.components.DateTimeInput.label)}
        >${this.#getPlaceholderText()}</label
      >
      <input
        autocomplete="off"
        class=${e$3(this.theme.components.DateTimeInput.element)}
        style=${this.theme.additionalStyles?.DateTimeInput ? o$7(this.theme.additionalStyles?.DateTimeInput) : A}
        @input=${(evt) => {
          if (!(evt.target instanceof HTMLInputElement)) {
            return;
          }
...
let Divider = (() => {
  ...
  var Divider = class extends _classSuper {
    ...
    render() {
      ...
      style=${this.theme.additionalStyles?.Divider ? o$7(this.theme.additionalStyles?.Divider) : A}
    />`;
    }
    static {
...
let Icon = (() => {
  ...
  var Icon = class extends _classSuper {
    ...
    render() {
      ...
      style=${this.theme.additionalStyles?.Icon ? o$7(this.theme.additionalStyles?.Icon) : A}
    >
      ${this.#renderIcon()}
    </section>`;
    }
...
let List = (() => {
  ...
  var List = class extends _classSuper {
    ...
    render() {
      ...
      style=${this.theme.additionalStyles?.List ? o$7(this.theme.additionalStyles?.List) : A}
    >
      <slot></slot>
    </section>`;
    }
...
let Modal = (() => {
  ...
  var Modal = class extends _classSuper {
    ...
    #showModal_accessor_storage = __runInitializers$8(this, _private_showModal_initializers, false);
    get #showModal() {
    ...
    #modalRef_accessor_storage =
      (__runInitializers$8(this, _private_showModal_extraInitializers),
      __runInitializers$8(this, _private_modalRef_initializers, null));
    get #modalRef() {
    ...
    >
      <section
        ...
        style=${this.theme.additionalStyles?.Modal ? o$7(this.theme.additionalStyles?.Modal) : A}
      >
        <div id="controls">
          <button
            @click=${() => {
    ...
    constructor() {
      super(...arguments);
      __runInitializers$8(this, _private_modalRef_extraInitializers);
    }
    static {
...
let MultipleChoice = (() => {
  ...
  var MultipleChoice = class extends _classSuper {
    ...
    #description_accessor_storage = __runInitializers$7(this, _description_initializers, null);
    get description() {
    ...
    #options_accessor_storage =
      (__runInitializers$7(this, _description_extraInitializers),
      __runInitializers$7(this, _options_initializers, []));
    get options() {
    ...
    #selections_accessor_storage =
      (__runInitializers$7(this, _options_extraInitializers),
      __runInitializers$7(this, _selections_initializers, []));
    get selections() {
    ...
    render() {
      return b`<section class=${e$3(this.theme.components.MultipleChoice.container)}>
      ...
      <select
        ...
        style=${this.theme.additionalStyles?.MultipleChoice ? o$7(this.theme.additionalStyles?.MultipleChoice) : A}
        @change=${(evt) => {
    ...
    constructor() {
      super(...arguments);
      __runInitializers$7(this, _selections_extraInitializers);
    }
    static {
...
let Row = (() => {
  ...
  var Row = class extends _classSuper {
    ...
    render() {
      ...
      style=${this.theme.additionalStyles?.Row ? o$7(this.theme.additionalStyles?.Row) : A}
    >
      <slot></slot>
    </section>`;
    }
...
let Slider = (() => {
  ...
  var Slider = class extends _classSuper {
    ...
    #renderField(value) {
      return b`<section class=${e$3(this.theme.components.Slider.container)}>
      ...
      <input
        ...
        style=${this.theme.additionalStyles?.Slider ? o$7(this.theme.additionalStyles?.Slider) : A}
        @input=${(evt) => {
          if (!(evt.target instanceof HTMLInputElement)) {
            return;
          }
...
let Tabs = (() => {
  ...
  var Tabs = class extends _classSuper {
    ...
    #renderTabs() {
      ...
      return b`<div id="buttons" class=${e$3(this.theme.components.Tabs.element)}>
    ...
    render() {
      ...
      style=${this.theme.additionalStyles?.Tabs ? o$7(this.theme.additionalStyles?.Tabs) : A}
    >
...
let TextField = (() => {
  ...
  var TextField = class extends _classSuper {
    ...
    #renderField(value, label) {
      return b` <section class=${e$3(this.theme.components.TextField.container)}>
      ${
        label && label !== ''
          ? b`<label class=${e$3(this.theme.components.TextField.label)} for="data"
            >${label}</label
          >`
          : A
      }
      <input
        ...
        style=${this.theme.additionalStyles?.TextField ? o$7(this.theme.additionalStyles?.TextField) : A}
        @input=${(evt) => {
          if (!(evt.target instanceof HTMLInputElement)) {
            return;
          }
...
var MarkdownDirective = class extends i$4 {
...
const markdown = e$8(MarkdownDirective);
...
let Text = (() => {
  ...
  var Text = class extends _classSuper {
    ...
    render() {
      ...
      return b`<section
      class=${e$3(classes)}
      style=${this.theme.additionalStyles?.Text ? o$7(this.#getAdditionalStyles()) : A}
    >
      ${this.#renderText()}
    </section>`;
    }
...
let Video = (() => {
  ...
  var Video = class extends _classSuper {
    ...
    render() {
      ...
      style=${this.theme.additionalStyles?.Video ? o$7(this.theme.additionalStyles?.Video) : A}
    >
      ${this.#renderVideo()}
    </section>`;
    }
...
var OpenClawA2UIHost = class extends i$5 {
  static properties = {
    surfaces: { state: true },
