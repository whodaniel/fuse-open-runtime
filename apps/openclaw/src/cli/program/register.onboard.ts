...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .option(
      '--auth-choice <choice>',
      'Auth: setup-token|token|chutes|openai-codex|openai-api-key|openrouter-api-key|sambanova-api-key|together-api-key|ai-gateway-api-key|moonshot-api-key|kimi-code-api-key|synthetic-api-key|venice-api-key|gemini-api-key|zai-api-key|xiaomi-api-key|apiKey|minimax-api|minimax-api-lightning|opencode-zen|skip'
    )
    .option(
      '--token-provider <id>',
        ...
        await onboardCommand(
          {
            ...
            sambanovaApiKey: opts.sambanovaApiKey as string | undefined,
