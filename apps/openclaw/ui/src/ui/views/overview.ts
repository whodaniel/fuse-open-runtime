  ...
  const authHint = (() => {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <span class="mono">openclaw dashboard --no-open</span>, or update the token, then click
        Connect.
        <div style="margin-top: 6px">
          <a
            class="session-link"
      ...
      <div class="card">
        ...
        <div class="form-grid" style="margin-top: 16px;">
          ...
          <label class="field">
            ...
            <div class="row" style="gap: 8px;">
              <input
                type="checkbox"
                .checked=${props.settings.rememberTokenFromUrl}
                @change=${(e: Event) => {
                  const next = (e.target as HTMLInputElement).checked;
                  props.onSettingsChange({ ...props.settings, rememberTokenFromUrl: next });
                }}
              />
        ...
        <div class="row" style="margin-top: 14px;">
          ...
          <button
            ...
            @click=${async () => {
              try {
                ...
                if (text.trim()) {
                  props.onSettingsChange({ ...props.settings, token: text.trim() });
                }
              } catch {
          ...
          ${props.onShowAuthModal
            ? html`<button class="btn" @click=${() => props.onShowAuthModal?.()}>
                Show Auth Modal
              </button>`
            : nothing}
