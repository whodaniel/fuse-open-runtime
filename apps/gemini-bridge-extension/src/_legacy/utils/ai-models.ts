...
export class AIModelsManager {
   ...
   */
  async query(prompt: string, options: AIQueryOptions = {}): Promise<any> {
    // Return type changed to any for simplicity, should be specific
    ...
    return new Promise((resolve, reject) => {
      ...
      const queryContext = {
        // Renamed from queryObj to avoid confusion
        id: queryId,
        prompt,
        options,
        resolve,
      ...
      const requestMessage: {
        ...
        // Using inline type instead of BaseMessage
        id: queryId,
