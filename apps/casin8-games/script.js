...
async function api(path, options = {}) {
  ...
  let lastErr = null;
  const base = options.baseUrl !== undefined ? String(options.baseUrl) : apiBase();
  const url = path.startsWith('http')
    ? path
    : path.startsWith('/')
      ? path
      : `${base}${base && !base.endsWith('/') ? '/' : ''}${path}`;
...
function renderGameToText() {
  const bankroll = Number(bankrollEl?.textContent || 0);
  const rounds = Number(roundsEl?.textContent || 0);
  const wins = Number(winsEl?.textContent || 0);
  const losses = Number(lossesEl?.textContent || 0);
  const live = state.liveSnapshot
    ? {
        tableId: state.liveSnapshot.tableId || state.tableId,
        heroSeat: state.liveSnapshot.heroSeat ?? null,
        actingSeat: state.liveSnapshot.actingSeat ?? null,
        pot: state.liveSnapshot.pot ?? null,
        stage: state.liveSnapshot.stage ?? null,
      }
    : null;
  const payload = {
    mode: 'console',
    ...
    losses,
    live,
    tableEvents: Array.isArray(state.tableEvents)
      ? state.tableEvents.slice(-3).map((e) => ({
          id: e.id || null,
          type: e.type || null,
          detail: e.detail || null,
        }))
      : [],
    note: 'origin: DOM stats; axes: N/A',
  };
...
const ASSET_BASE = window.location.pathname.startsWith('/console') ? '/console/assets' : '/assets';
const CARD_ASSET_BASE = window.location.pathname.startsWith('/console')
  ? '/console/assets'
  : '/assets';
const pokerUiAssetMap = {
  brandLogo: '/poker/pkr_brand_logo_mark_idle_v01.png',
  brandWordmark: '/poker/pkr_brand_wordmark_light_v01.png',
  shellBgDesktop: '/poker/pkr_shell_bg_main_desktop_idle_v01.png',
  shellBgMobile: '/poker/pkr_shell_bg_main_mobile_idle_v01.png',
  tableFelt6max: '/poker/pkr_table_felt_6max_topdown_idle_v01.png',
  tableFelt9max: '/poker/pkr_table_felt_9max_topdown_idle_v01.png',
  tableRailCloseup: '/poker/pkr_table_rail_material_closeup_v01.png',
  stageScene: '/poker/pkr_stage_cinematic_table_scene_v01.png',
  chip1: '/poker/pkr_chip_denom_1_idle_v01.png',
  chip5: '/poker/pkr_chip_denom_5_idle_v01.png',
  chip25: '/poker/pkr_chip_denom_25_idle_v01.png',
  chip100: '/poker/pkr_chip_denom_100_idle_v01.png',
  chip500: '/poker/pkr_chip_denom_500_idle_v01.png',
  chipStackSmall: '/poker/pkr_chip_stack_small_idle_v01.png',
  chipStackLarge: '/poker/pkr_chip_stack_large_idle_v01.png',
  avatarHuman: '/poker/pkr_avatar_frame_human_idle_v01.png',
  avatarAgent: '/poker/pkr_avatar_frame_agent_idle_v01.png',
  dealerMarker: '/poker/pkr_marker_dealer_button_idle_v01.png',
  markerSbBb: '/poker/pkr_marker_sb_bb_set_idle_v01.png',
  markerAllIn: '/poker/pkr_marker_allin_badge_set_v01.png',
  seatRingIdle: '/poker/pkr_seat_ring_idle_v01.png',
  seatRingActive: '/poker/pkr_seat_ring_active_turn_v01.png',
  badgeTierA: '/poker/pkr_badge_agent_tier_a_v01.png',
  badgeTierB: '/poker/pkr_badge_agent_tier_b_v01.png',
  badgeTierC: '/poker/pkr_badge_agent_tier_c_v01.png',
  badgeSponsored: '/poker/pkr_badge_sponsored_player_v01.png',
  foldButton: '/poker/pkr_btn_fold_set_v01.png',
  checkCallButton: '/poker/pkr_btn_checkcall_set_v01.png',
  raiseButton: '/poker/pkr_btn_raise_primary_set_v01.png',
  sliderRaiseTrack: '/poker/pkr_slider_raise_track_set_v01.png',
  quickbetRow: '/poker/pkr_quickbet_chip_row_v01.png',
  cardBack: '/poker/pkr_card_back_primary_idle_v01.png',
  cardBackAlt: '/poker/pkr_card_back_alt_royal_idle_v01.png',
  cardShadow: '/poker/pkr_card_shadow_soft_idle_v01.png',
  cardGlow: '/poker/pkr_card_glow_win_fx_v01.png',
  cardFlip01: '/poker/pkr_card_flip_frame_01_v01.png',
  cardFlip02: '/poker/pkr_card_flip_frame_02_v01.png',
  cardFlip03: '/poker/pkr_card_flip_frame_03_v01.png',
  panelFairness: '/poker/pkr_panel_fairness_idle_v01.png',
  panelTxLifecycle: '/poker/pkr_panel_tx_lifecycle_idle_v01.png',
  panelLedgerRow: '/poker/pkr_panel_ledger_row_set_v01.png',
  panelNetworkHealth: '/poker/pkr_panel_network_health_set_v01.png',
  panelSponsorMarketCard: '/poker/pkr_panel_sponsor_market_card_v01.png',
  panelChatFeedBg: '/poker/pkr_panel_chat_feed_bg_v01.png',
  tourneyLobbyHero: '/poker/pkr_tourney_lobby_hero_bg_v01.png',
  blindLevelTimeline: '/poker/pkr_blind_level_timeline_v01.png',
  payoutLadder: '/poker/pkr_payout_ladder_panel_v01.png',
  finalTableBanner: '/poker/pkr_final_table_banner_v01.png',
  eliminationFx: '/poker/pkr_elimination_burst_fx_v01.png',
  stateReconnecting: '/poker/pkr_state_reconnecting_banner_v01.png',
  stateChainMismatch: '/poker/pkr_state_chain_mismatch_card_v01.png',
  stateInsufficientFunds: '/poker/pkr_state_insufficient_funds_card_v01.png',
  stateSettlementPending: '/poker/pkr_state_settlement_pending_overlay_v01.png',
  stateDuplicateAction: '/poker/pkr_state_duplicate_action_guard_v01.png',
  mobileBottomActionSheet: '/poker/pkr_mobile_bottom_action_sheet_v01.png',
  mobileTabbar: '/poker/pkr_mobile_tabbar_pokerroom_v01.png',
  mobileHudDrawer: '/poker/pkr_mobile_hud_drawer_handle_v01.png',
  mobileTableHeader: '/poker/pkr_mobile_table_header_compact_v01.png',
};

function pokerUiAsset(key) {
  const asset = pokerUiAssetMap[key];
  if (!asset) return '';
...
function cardAssetUrl(code) {
  ...
  return `${CARD_ASSET_BASE}/cards/english_pattern_${rankName}_of_${suitName}.svg`;
}
