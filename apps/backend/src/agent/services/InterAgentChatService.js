        ...
        try {
            await this.redisService.subscribe(channel, (message) => {
                try {
                    ...
                    this.alertService.error('agent.message.parse.failed', 'Failed to parse incoming message', { error: error.message });
                }
            });
...
exports.InterAgentChatService = InterAgentChatService = __decorate([
    ...
    __metadata("design:paramtypes", [config_1.ConfigService,
        ...
        MonitoringService_1.MonitoringService, typeof (_a = typeof event_emitter_1.EventEmitter2 !== "undefined" && event_emitter_1.EventEmitter2) === "function" ? _a : Object])
