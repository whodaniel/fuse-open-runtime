...
export declare class ChatService {
    ...
    static getChatHistory(userId: string, page?: number, pageSize?: number): Promise<{
        messages: ChatMessage[];
        total: number;
        hasMore: boolean;
        currentPage: number;
    ...
    static addMessage(userId: string, role: string, content: string): Promise<ChatMessage>;
    static clearChatHistory(userId: string): Promise<Prisma.BatchPayload>;
}
