...
import { Controller, Get, Post, Put, Delete, UseGuards, HttpStatus, HttpCode } from '@nestjs/common';
import { JwtAuthGuard } from '../auth/guards/jwt-auth.guard.js';
import { RolesGuard } from '../auth/guards/roles.guard.js';
import { Roles } from '../auth/decorators/roles.decorator.js';
import { ApiTags, ApiOperation } from '@nestjs/swagger';
let UsersController = (() => {
    let _classDecorators = [ApiTags('users'), Controller('users'), UseGuards(JwtAuthGuard, RolesGuard)];
    ...
    (() => {
        ...
        _create_decorators = [Post(), Roles('admin'), ApiOperation({ summary: 'Create new user' })];
        _findAll_decorators = [Get(), Roles('admin'), ApiOperation({ summary: 'Get all users' })];
        _findOne_decorators = [Get(':id'), ApiOperation({ summary: 'Get user by id' })];
        _update_decorators = [Put(':id'), ApiOperation({ summary: 'Update user' })];
        _delete_decorators = [Delete(':id'), Roles('admin'), HttpCode(HttpStatus.NO_CONTENT), ApiOperation({ summary: 'Delete user' })];
