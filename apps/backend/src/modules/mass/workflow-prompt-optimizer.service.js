...
exports.WorkflowPromptOptimizerService = void 0;
...
let WorkflowPromptOptimizerService = WorkflowPromptOptimizerService_1 = class WorkflowPromptOptimizerService {
    prisma;
    evaluationHarness;
    logger = new common_1.Logger(WorkflowPromptOptimizerService_1.name);
    ...
    async evaluateNodeInWorkflowContext(targetNode, candidatePrompt, allNodes, edges, dataset, config) {
        ...
        for (const item of sampleItems) {
            try {
                const result = await this.evaluationHarness.evaluateWorkflowWithNodes(tempNodes, edges, item, config);
...
exports.WorkflowPromptOptimizerService = WorkflowPromptOptimizerService;
exports.WorkflowPromptOptimizerService = WorkflowPromptOptimizerService = WorkflowPromptOptimizerService_1 = __decorate([
