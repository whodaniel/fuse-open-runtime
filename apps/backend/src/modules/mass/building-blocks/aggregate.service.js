...
let AggregateService = class AggregateService {
    aggregateBlock;
    agentExecutor;
    constructor(aggregateBlock, agentExecutor) {
        this.aggregateBlock = aggregateBlock;
        this.agentExecutor = agentExecutor;
    }
    async execute(agentId, inputs, config) {
...
exports.AggregateService = AggregateService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [mass_blocks_service_1.AggregateBlock,
