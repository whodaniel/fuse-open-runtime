...
let BusinessEventService = BusinessEventService_1 = class BusinessEventService {
    businessEventRepo;
    sseService;
    logger = new common_1.Logger(BusinessEventService_1.name);
    ...
    async processEvent(eventId) {
        try {
            ...
            if (event.processingStatus !== types_1.ProcessingStatus.PENDING) {
            ...
            await this.businessEventRepo.update(eventId, {
                processingStatus: types_1.ProcessingStatus.COMPLETED,
            ...
            if (event) {
                await this.businessEventRepo.update(eventId, {
                    processingStatus: types_1.ProcessingStatus.FAILED,
    ...
    async getEventStats(organizationId, days = 7) {
        ...
        events.forEach(event => {
            ...
            if (event.processedAt && event.processingStatus === types_1.ProcessingStatus.COMPLETED) {
...
exports.BusinessEventService = BusinessEventService = BusinessEventService_1 = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(business_event_entity_1.BusinessEvent)),
