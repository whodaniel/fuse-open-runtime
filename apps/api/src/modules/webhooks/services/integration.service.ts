...
export class IntegrationService {
  ...
  private mapStripeEventType(stripeEventType: string): BusinessEventType {
  ...
  private mapPayPalEventType(paypalEventType: string): BusinessEventType {
    const eventMap: Record<string, BusinessEventType> = {
  ...
  private mapSalesforceEventType(sobjectType: any): BusinessEventType {
  ...
  private mapHubSpotEventType(subscriptionType: string, changeType: string): BusinessEventType {
    const eventMap: Record<string, BusinessEventType> = {
  ...
  private mapPipedriveEventType(event: string, objectType: string): BusinessEventType {
    const eventMap: Record<string, BusinessEventType> = {
  ...
  private mapSquareEventType(squareEventType: string): BusinessEventType {
    const eventMap: Record<string, BusinessEventType> = {
  ...
  private determinePriority(eventType: BusinessEventType): EventPriority {
