...
let PromptOptimizerService = PromptOptimizerService_1 = class PromptOptimizerService {
    ...
    llmService;
    evaluationHarness;
    logger = new Logger(PromptOptimizerService_1.name);
    ...
    async optimizeAgentPrompt(agentId, config) {
        ...
        try {
            ...
            const agent = await this.prisma.agent.findUnique({
                where: { id: agentId }
                // include: { promptVersions: true } // Field not in schema
            });
            if (!agent) {
...
PromptOptimizerService = PromptOptimizerService_1 = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [typeof (_a = typeof PrismaService !== "undefined" && PrismaService) === "function" ? _a : Object, LlmInteractionService,
...
let LlmInteractionService = LlmInteractionService_1 = class LlmInteractionService {
    logger = new Logger(LlmInteractionService_1.name);
...
LlmInteractionService = LlmInteractionService_1 = __decorate([
    Injectable()
], LlmInteractionService);
export { LlmInteractionService };
let EvaluationHarnessService = EvaluationHarnessService_1 = class EvaluationHarnessService {
    llmService;
    logger = new Logger(EvaluationHarnessService_1.name);
...
EvaluationHarnessService = EvaluationHarnessService_1 = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [LlmInteractionService])
], EvaluationHarnessService);
export { EvaluationHarnessService };
//# sourceMappingURL=prompt-optimizer.service.js.map