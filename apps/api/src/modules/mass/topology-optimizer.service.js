...
let TopologyOptimizerService = TopologyOptimizerService_1 = class TopologyOptimizerService {
    prisma;
    evaluationHarness;
    logger = new Logger(TopologyOptimizerService_1.name);
    ...
    async calculateInfluenceScores(agents, config) {
        ...
        for (const agent of agents) {
            try {
                ...
                const agentAccuracy = agentMetrics.accuracy || 0;
                const influence = baselineAccuracy > 0 ?
                    (agentAccuracy - baselineAccuracy) / baselineAccuracy : 0;
    ...
    async generateRandomTopology(agents, influenceScores, config) {
        ...
        return await this.generateTopologyByPattern(randomPattern, selectedAgents, influenceScores, config);
    }
...
TopologyOptimizerService = TopologyOptimizerService_1 = __decorate([
    Injectable(),
...
export { TopologyOptimizerService };
//# sourceMappingURL=topology-optimizer.service.js.map