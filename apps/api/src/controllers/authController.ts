...
// import { userService } from '../services/userService'; // Commented out as userService is not exported as a constant
...
// export const authController = new AuthController(); // Commented out due to build errors
