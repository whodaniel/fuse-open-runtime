...
export class LocalAIController {
  ...
  constructor(
    ...
    // private localAIDetection: LocalAIDetectionService // Commented out due to build errors
  ) {}
  ...
  async detectLocalAIs() {
    throw new HttpException(
      'Local AI detection is not currently available',
  ...
  async registerLocalAIs(@Request() req: AuthenticatedRequest) {
    throw new HttpException(
      'Local AI registration is not currently available',
      HttpStatus.NOT_IMPLEMENTED
    );
  }
  ...
  async refreshLocalAIs(@Request() req: AuthenticatedRequest) {
    throw new HttpException(
      'Local AI refresh is not currently available',
      HttpStatus.NOT_IMPLEMENTED
    );
  }
  ...
  async getLocalAIAgents(@Request() req: AuthenticatedRequest) {
    throw new HttpException(
      'Local AI agents retrieval is not currently available',
      HttpStatus.NOT_IMPLEMENTED
    );
  }
  ...
  async getLocalAIAgentStatus(
    @Param('agentId') agentId: string,
    @Request() req: AuthenticatedRequest
  ) {
    throw new HttpException(
      'Local AI agent status check is not currently available',
      HttpStatus.NOT_IMPLEMENTED
    );
  }
  ...
  async createSystemAgents() {
    throw new HttpException(
      'Creating system local AI agents is not currently available',
      HttpStatus.NOT_IMPLEMENTED
    );
  }
}
