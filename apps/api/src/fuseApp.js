...
app.post('/agents/new', async (req, res) => {
    ...
    try {
        await pool.query('INSERT INTO agents (name, description, agent_type, language_model, custom_prompt, custom_parameters, user_id) VALUES ($1, $2, $3, $4, $5, $6, $7)', [name, description, agent_type, language_model, custom_prompt, custom_parameters, req.session.user_id]);
