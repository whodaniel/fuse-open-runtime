...
export function createWorkflowRoutes(workflowController: WorkflowController): Router {
  ...
  router.post('/', 
    validateRequest(workflowValidationSchemas.create),
    workflowController.createWorkflow.bind(workflowController)
  );
  router.patch('/:id', 
    validateRequest(workflowValidationSchemas.update),
  ...
  router.post('/execute', 
    validateRequest(workflowValidationSchemas.execute),
  ...
  router.post('/validate', 
    validateRequest(workflowValidationSchemas.validate),
  ...
  router.post('/from-template', 
    validateRequest(workflowValidationSchemas.fromTemplate),
