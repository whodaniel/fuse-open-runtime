...
let AuthSession = (() => {
    ...
    var AuthSession = _classThis = class {
        constructor() {
            ...
            this.token = (__runInitializers(this, _userId_extraInitializers), __runInitializers(this, _token_initializers, void 0));
            this.lastActivity = (__runInitializers(this, _token_extraInitializers), __runInitializers(this, _lastActivity_initializers, void 0));
    ...
    __setFunctionName(_classThis, "AuthSession");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [PrimaryGeneratedColumn('uuid')];
        _user_decorators = [ManyToOne(() => User, user => user.authSessions)];
        _userId_decorators = [Column()];
        _token_decorators = [Column({ unique: true })];
        _lastActivity_decorators = [Column()];
        ...
        AuthSession = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AuthSession = _classThis;
})();
export { AuthSession };
