...
let Agent = (() => {
    ...
    var Agent = _classThis = class {
        constructor() {
            ...
            this.user = (__runInitializers(this, _config_extraInitializers), __runInitializers(this, _user_initializers, void 0));
            this.userId = (__runInitializers(this, _user_extraInitializers), __runInitializers(this, _userId_initializers, void 0));
            this.pipelines = (__runInitializers(this, _userId_extraInitializers), __runInitializers(this, _pipelines_initializers, void 0));
            this.createdAt = (__runInitializers(this, _pipelines_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (() => {
        ...
        _user_decorators = [ManyToOne(() => User, user => user.agents)];
        _userId_decorators = [Column()];
        _pipelines_decorators = [OneToMany(() => Pipeline, pipeline => pipeline.agent)];
