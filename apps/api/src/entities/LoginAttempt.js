...
let LoginAttempt = (() => {
    ...
    var LoginAttempt = _classThis = class {
        constructor() {
            ...
            this.success = (__runInitializers(this, _userId_extraInitializers), __runInitializers(this, _success_initializers, void 0));
            this.ipAddress = (__runInitializers(this, _success_extraInitializers), __runInitializers(this, _ipAddress_initializers, void 0));
    ...
    __setFunctionName(_classThis, "LoginAttempt");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [PrimaryGeneratedColumn('uuid')];
        _user_decorators = [ManyToOne(() => User, user => user.loginAttempts)];
        _userId_decorators = [Column()];
        _success_decorators = [Column()];
        _ipAddress_decorators = [Column({ nullable: true })];
        _userAgent_decorators = [Column({ nullable: true })];
        ...
        LoginAttempt = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return LoginAttempt = _classThis;
})();
export { LoginAttempt };
