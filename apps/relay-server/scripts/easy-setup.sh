...
echo "===================================================="
echo "  The New Fuse - Easy Setup"
echo "===================================================="
echo ""

# First make this script executable (in case it was copied without permissions)
chmod +x "$0"

# Create the directories we need
mkdir -p src/vscode-extension/out
mkdir -p src/vscode-extension/mcp-integration
mkdir -p src/vscode-extension/data
mkdir -p src/vscode-extension/db

cd src/vscode-extension

# Create the setup script directly in the correct location
...
echo ""
echo "The easy setup is complete! You can now run the extension with:"
echo ""
echo "  cd src/vscode-extension && ./launch.sh"
echo ""
echo "===================================================="
