...
const TestPage: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-transparent shadow rounded-md p-4 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <div className="bg-transparent p-4 rounded-md">
            ...
            <p className="text-muted-foreground">
              Test how components respond to different screen sizes
            </p>
          </div>

          <div className="bg-transparent p-4 rounded-md">
            <h3 className="font-medium text-lg mb-2">Component States</h3>
            <p className="text-muted-foreground">Test various component states and interactions</p>
          </div>

          <div className="bg-transparent p-4 rounded-md">
            <h3 className="font-medium text-lg mb-2">Theme Testing</h3>
            <p className="text-muted-foreground">Verify theme consistency across components</p>
          </div>

          <div className="bg-transparent p-4 rounded-md">
            <h3 className="font-medium text-lg mb-2">Performance Testing</h3>
            <p className="text-muted-foreground">Check component rendering performance</p>
          </div>
        </div>
      </div>
