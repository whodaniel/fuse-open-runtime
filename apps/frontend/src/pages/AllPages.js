...
var AllPages = function () {
    ...
    var filteredCategories = pageCategories
        .map(function (category) { return (__assign(__assign({}, category), { pages: category.pages.filter(function (page) {
        ...
        .filter(function (category) { return category.pages.length > 0; });
    var totalPages = allPages.length;
    return (_jsx("div", { className: "min-h-screen bg-gray-100 dark:bg-gray-900 p-8", children: _jsxs("div", { className: "max-w-7xl mx-auto", children: [_jsxs("div", { className: "text-center mb-8", children: [_jsx("h1", { className: "text-4xl font-bold text-gray-900 dark:text-white mb-4", children: "\uD83D\uDE80 The New Fuse - All Pages" }), _jsxs("p", { className: "text-lg text-gray-700 dark:text-gray-300 mb-4", children: ["Complete directory of all ", totalPages, " pages in The New Fuse application"] }), _jsx("div", { className: "bg-green-100 dark:bg-green-900 border border-green-400 text-green-700 dark:text-green-300 px-4 py-3 rounded-lg inline-block", children: "\u2705 All pages are accessible and routed correctly" })] }), _jsxs("div", { className: "mb-8 flex flex-col md:flex-row gap-4", children: [_jsx("div", { className: "flex-1", children: _jsx("input", { type: "text", placeholder: "Search pages by name, path, or description...", value: searchTerm, onChange: function (e) { return setSearchTerm(e.target.value); }, className: "w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500" }) }), _jsx("div", { children: _jsxs("select", { value: selectedCategory, onChange: function (e) { return setSelectedCategory(e.target.value); }, className: "px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500", children: [_jsx("option", { value: "All", children: "All Categories" }), pageCategories.map(function (category) { return (_jsxs("option", { value: category.name, children: [category.name, " (", category.pages.length, ")"] }, category.name)); })] }) })] }), filteredCategories.map(function (category, categoryIndex) { return (_jsxs("div", { className: "mb-12", children: [_jsxs("h2", { className: "text-2xl font-bold text-gray-800 dark:text-white mb-6 flex items-center", children: [_jsx("span", { className: "bg-blue-600 text-white px-3 py-1 rounded-full text-sm mr-3", children: category.pages.length }), category.name] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: category.pages.map(function (page, pageIndex) { return (_jsxs("div", { className: "p-6 border rounded-lg bg-white dark:bg-gray-800 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105", children: [_jsx("h3", { className: "text-xl font-bold text-gray-800 dark:text-white mb-2", children: page.name }), page.description && (_jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400 mb-3", children: page.description })), _jsx("div", { className: "mb-4", children: _jsx("code", { className: "text-xs font-mono text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 px-2 py-1 rounded", children: page.path }) }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Link, { to: page.path, className: "px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors inline-block text-sm font-medium", children: "Visit Page" }), _jsx("button", { onClick: function () {
                                                    var fullUrl = "http://localhost:3000".concat(page.path);
                                                    navigator.clipboard.writeText(fullUrl);
                                                }, className: "px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors text-sm", title: "Copy URL to clipboard", children: "Copy URL" })] })] }, pageIndex)); }) })] }, categoryIndex)); }), filteredCategories.length === 0 && (_jsx("div", { className: "text-center py-12", children: _jsx("p", { className: "text-gray-500 dark:text-gray-400 text-lg", children: "No pages found matching your search criteria." }) })), _jsxs("div", { className: "mt-12 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700", children: [_jsx("h3", { className: "text-lg font-bold text-blue-800 dark:text-blue-300 mb-2", children: "\uD83D\uDCCA Application Summary" }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 text-sm", children: [_jsxs("div", { children: [_jsx("strong", { className: "text-blue-700 dark:text-blue-300", children: "Total Pages:" }), _jsx("br", {}), totalPages, " routes"] }), _jsxs("div", { children: [_jsx("strong", { className: "text-blue-700 dark:text-blue-300", children: "Categories:" }), _jsx("br", {}), pageCategories.length, " sections"] }), _jsxs("div", { children: [_jsx("strong", { className: "text-blue-700 dark:text-blue-300", children: "Server:" }), _jsx("br", {}), "localhost:3000"] }), _jsxs("div", { children: [_jsx("strong", { className: "text-blue-700 dark:text-blue-300", children: "Status:" }), _jsx("br", {}), "All routed \u2705"] })] })] })] }) }));
};
