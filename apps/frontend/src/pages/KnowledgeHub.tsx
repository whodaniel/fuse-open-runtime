...
const MOCK_CLUSTERS = [
  {
    ...
    items: [
      {
        id: 'i1',
        content: 'Portfolio Optimization V2',
        metadata: { confidence: 0.95, source: 'alg-v2-final' },
      },
      {
        id: 'i2',
        content: 'Risk Assessment Module',
        metadata: { confidence: 0.88, source: 'risk-engine' },
      },
      {
        id: 'i3',
        content: 'Arbitrage Strategy 7',
        metadata: { confidence: 0.92, source: 'market-data-hub' },
      },
    ],
  },
  {
    ...
    items: [
      {
        id: 'i4',
        content: 'Draft of Q1 Report',
        metadata: { confidence: 0.99, source: 'writer-agent' },
      },
      {
        id: 'i5',
        content: 'Meeting Notes: Core Design',
        metadata: { confidence: 0.85, source: 'coord-agent' },
      },
    ],
  },
  {
    ...
    items: [
      {
        id: 'i6',
        content: 'Mesh Gateway Config',
        metadata: { confidence: 0.94, source: 'net-admin' },
      },
    ],
  },
];
