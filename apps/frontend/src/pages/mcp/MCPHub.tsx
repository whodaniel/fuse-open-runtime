import { Box, Cpu, Globe, Layout, RotateCcw, Search, Settings, Shield, Zap } from 'lucide-react';
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <MetricCard
          ...
          label="Total Tools"
          value={agents.reduce((acc, s) => acc + (s.tools?.length || 0), 0).toString()}
        />
        <MetricCard
          icon={<Box className="text-purple-400" />}
          label="Shared Resources"
          value={agents.reduce((acc, s) => acc + (s.resources?.length || 0), 0).toString()}
        />
