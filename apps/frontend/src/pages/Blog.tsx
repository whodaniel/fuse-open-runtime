...
export const Blog = () => {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEOHead
        title="The New Fuse - Blog | AI Collaboration Platform"
        description="Latest news, updates, and insights from The New Fuse AI collaboration platform."
        keywords={['AI platform blog', 'workflow automation news']}
      />
      <LandingHeader />
