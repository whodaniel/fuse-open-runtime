...
const mockSuggestions = [
  {
    ...
    description:
      'Create an AI agent that can automatically review code and provide suggestions for improvements.',
    status: 'Under Review',
  ...
  },
  {
    ...
    description:
      'Implement a natural language search feature for the documentation to make it easier for users to find what they need.',
    status: 'Approved',
  ...
  },
  {
    ...
    description:
      'Develop a drag-and-drop interface for creating agent workflows without writing code.',
    status: 'Implemented',
  ...
  },
  {
    ...
    description:
      'Add support for integrating with popular third-party AI services like OpenAI, Anthropic, and Cohere.',
    status: 'Submitted',
  ...
  },
  {
    ...
    description:
      'Add real-time collaboration features to allow multiple users to work on the same project simultaneously.',
    status: 'Under Review',
  ...
  },
  {
    ...
    description:
      'Develop a mobile application that allows users to monitor and manage their agents on the go.',
    status: 'Submitted',
    category: 'Mobile',
    votes: 19,
    comments: 2,
  ...
  },
  {
    ...
    description:
      'Allow users to create and share custom agent templates to make it easier to create new agents.',
    status: 'Approved',
  ...
  },
  {
    ...
    description:
      'Create a comprehensive analytics dashboard to provide insights into agent performance and usage.',
    status: 'Under Review',
    category: 'Analytics',
    votes: 33,
    comments: 6,
...
const Suggestions: React.FC = () => {
  ...
  const suggestionStatuses = [
    'All',
    ...new Set(mockSuggestions.map((suggestion) => suggestion.status)),
  ];

  // Get unique suggestion categories for filter
  const suggestionCategories = [
    'All',
    ...new Set(mockSuggestions.map((suggestion) => suggestion.category)),
  ];
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'Implemented':
        return (
          <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-100">{status}</Badge>
        );
      case 'Rejected':
