...
const mockSuggestionDetails = {
  ...
  description:
    'Create an AI agent that can automatically review code and provide suggestions for improvements. The agent should be able to identify common issues, suggest optimizations, and follow best practices for different programming languages.\n\nThis would save developers time and help maintain code quality across projects. The agent could integrate with existing version control systems like GitHub and GitLab.',
  status: 'Under Review',
  ...
  comments: [
    {
      ...
      authorAvatar: 'JD',
      content:
        'This would be a great addition to our toolset. I spend a lot of time on code reviews.',
    ...
    },
    {
      ...
      authorAvatar: 'ED',
      content:
        'This would be especially useful for junior developers who are still learning best practices.',
...
const SuggestionDetail: React.FC = () => {
  ...
  const [userVote, setUserVote] = useState<'up' | 'down' | null>(
    mockSuggestionDetails.votes.userVote as 'up' | 'down' | null
  );
          ...
          <Card className="mb-6">
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex items-center">{getStatusBadge(suggestion.status)}</div>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-2">
                <Button
                  ...
                  onClick={() => navigate(`/suggestions/${id}/edit`)}
                >
