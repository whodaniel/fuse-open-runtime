...
var NOTIFICATION_EVENT = 'app:notification';
export function showNotification(options) {
    var event = new CustomEvent(NOTIFICATION_EVENT, {
        detail: __assign({ type: 'info', duration: 3000, position: 'top', dismissible: true }, options),
    });
