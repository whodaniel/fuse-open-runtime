        ...
        <Layout>
          <Suspense fallback={<LoadingFallback name="Page" />}>
            <Routes>
              ...
              />
              <Route path="/workflows/builder" element={<RequireAuth><WorkflowBuilder /></RequireAuth>} />
              <Route path="/workflows/executions" element={<RequireAuth><WorkflowExecutionPage /></RequireAuth>} />
              <Route path="/workflows/:id" element={<RequireAuth><WorkflowDetailPage /></RequireAuth>} />
              <Route path="/workflows/:id/execution" element={<RequireAuth><WorkflowExecutionPage /></RequireAuth>} />
              <Route path="/workflows/console" element={<RequireAuth><ExecutionConsole /></RequireAuth>} />
              <Route path="/workflows/advanced-builder" element={<RequireAuth><WorkflowEditorWrapper /></RequireAuth>} />
              <Route path="/workflows/templates" element={<RequireAuth><WorkflowTemplatesPage /></RequireAuth>} />
              <Route path="/workflows-enhanced" element={<RequireAuth><WorkflowsEnhancedPage /></RequireAuth>} />
              <Route path="/workflows/detail" element={<RequireAuth><WorkflowDetailPage /></RequireAuth>} />
              <Route path="/workflows/execution" element={<RequireAuth><WorkflowExecutionPage /></RequireAuth>} />
