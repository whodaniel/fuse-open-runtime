...
var apiSlice = (0, toolkit_1.createSlice)({
    name: 'api',
    ...
    reducers: {
        ...
        fetchDataFailure: function (state, action) {
            state.error = action.payload;
            state.loading = false;
        }
    }
});
var actions = apiSlice.actions;
...
var fetchData = function (endpoint, params) { return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetcher_1.default.get(endpoint, params)];
            case 1:
                response = _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                dispatch((0, exports.fetchDataFailure)(error_1.message));
                return [3 /*break*/, 3];
