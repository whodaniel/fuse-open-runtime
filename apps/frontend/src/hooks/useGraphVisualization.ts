...
export function useGraphVisualization(initialNodes = [], initialEdges = []): any {
  ...
  const handleClusteringUpdate = (0, react_1.useCallback)((data) => {
    setNodes((prev) =>
      prev.map((node) =>
        Object.assign(Object.assign({}, node), { community: data.communities.get(node.id) })
      )
    );
    setIsProcessing(false);
  }, []);
  ...
  const highlightedNodes = (0, react_1.useMemo)(() => {
    if (!state.highlighting.enabled || !metrics) return new Set();
  ...
  const updateLayout = (0, react_1.useCallback)(
    (layout) => {
      if (!socket) return;
  ...
  const updatePhysics = (0, react_1.useCallback)(
    (physics) => {
      setState((prev) =>
        Object.assign(Object.assign({}, prev), {
          physics: Object.assign(Object.assign({}, prev.physics), physics),
        })
      );
  ...
  const updateClustering = (0, react_1.useCallback)(
    (clustering) => {
      if (!socket) return;
      setIsProcessing(true);
      setState((prev) =>
        Object.assign(Object.assign({}, prev), {
          clustering: Object.assign(Object.assign({}, prev.clustering), clustering),
        })
      );
      socket.emit('graph:clustering:update', Object.assign({ nodes, edges }, clustering));
    },
    [socket, nodes, edges]
  );
  const updateHighlighting = (0, react_1.useCallback)((highlighting) => {
    setState((prev) =>
      Object.assign(Object.assign({}, prev), {
        highlighting: Object.assign(Object.assign({}, prev.highlighting), highlighting),
      })
    );
  }, []);
  const updateLabels = (0, react_1.useCallback)((labels) => {
    setState((prev) =>
      Object.assign(Object.assign({}, prev), {
        labels: Object.assign(Object.assign({}, prev.labels), labels),
      })
    );
  }, []);
  ...
  const exportGraph = (0, react_1.useCallback)(
    (format) => {
      if (!socket) return;
