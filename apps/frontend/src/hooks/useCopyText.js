...
export default function useCopyText(delay) {
    var _this = this;
    if (delay === void 0) { delay = 2500; }
    var _b = useState(false), copied = _b[0], setCopied = _b[1];
    var copyText = function (content) { return __awaiter(_this, void 0, void 0, function () {
        var _a;
    ...
    return { copyText: copyText, copied: copied };
}
