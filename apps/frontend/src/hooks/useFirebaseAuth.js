    ...
    var signIn = function (email, password) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    setError({ code: err_1.code, message: err_1.message });
                    throw err_1;
    ...
    var signInWithGoogle = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_2 = _a.sent();
                    setError({ code: err_2.code, message: err_2.message });
                    throw err_2;
                case 3: return [2 /*return*/];
            }
        });
    ...
    var signUp = function (email, password) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_3 = _a.sent();
                    setError({ code: err_3.code, message: err_3.message });
                    throw err_3;
                case 3: return [2 /*return*/];
            }
        });
    ...
    var resetPassword = function (email) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_4 = _a.sent();
                    setError({ code: err_4.code, message: err_4.message });
                    throw err_4;
                case 3: return [2 /*return*/];
            }
        });
    ...
    var logout = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_5 = _a.sent();
                    setError({ code: err_5.code, message: err_5.message });
                    throw err_5;
                case 3: return [2 /*return*/];
            }
        });
