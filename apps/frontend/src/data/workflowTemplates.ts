...
export const DEFAULT_WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    description:
      'Automated code review process with AI agents for syntax, security, and performance.',
    ...
    nodes: [
      { id: 'start', type: 'trigger', position: { x: 250, y: 0 }, data: { label: 'GitHub PR' } },
      {
        ...
        type: 'agent',
        position: { x: 0, y: 100 },
        data: { label: 'Syntax Check', agentType: 'code-analyzer' },
      },
      {
        id: 'security',
        type: 'agent',
        position: { x: 250, y: 100 },
        data: { label: 'Security Audit', agentType: 'security-auditor' },
      },
      {
        id: 'perf',
        type: 'agent',
        position: { x: 500, y: 100 },
        data: { label: 'Perf Check', agentType: 'performance-analyst' },
      },
      {
        id: 'summary',
        type: 'processing',
        position: { x: 250, y: 250 },
        data: { label: 'Summarize Reports' },
      },
      {
        id: 'notify',
        type: 'action',
        position: { x: 250, y: 350 },
        data: { label: 'Post Comment' },
      },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { label: 'AI Analysis', agentType: 'data-scientist' },
      },
      {
        id: 'viz',
        type: 'processing',
  ...
  },
  {
    ...
    nodes: [
      { id: 'topic', type: 'trigger', position: { x: 250, y: 0 }, data: { label: 'Topic Input' } },
      {
        ...
        type: 'agent',
        position: { x: 250, y: 100 },
        data: { label: 'Draft Writer', agentType: 'writer' },
      },
      {
        id: 'review',
        type: 'agent',
        position: { x: 250, y: 200 },
        data: { label: 'Editor Review', agentType: 'editor' },
      },
      {
        id: 'publish',
        type: 'action',
        position: { x: 250, y: 300 },
        data: { label: 'Publish CMS' },
      },
    ],
    edges: [
  ...
  },
  {
    ...
    description:
      'Orchestrate welcome emails, account setup, and resource allocation for new users.',
    category: 'Operations',
    complexity: 'medium',
    popularity: 'medium',
    nodes: [
