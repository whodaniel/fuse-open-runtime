...
export function getTemplateById(id) {
    return workflowTemplates.find(function (t) { return t.id === id; });
}
export function getTemplatesByCategory(category) {
    return workflowTemplates.filter(function (t) { return t.category === category; });
}
export function getTemplatesByDifficulty(difficulty) {
    return workflowTemplates.filter(function (t) { return t.difficulty === difficulty; });
}
export function searchTemplates(query) {
    var lowerQuery = query.toLowerCase();
    return workflowTemplates.filter(function (t) {
