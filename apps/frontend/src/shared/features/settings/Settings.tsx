...
export function Settings({ onSettingChange }) {
  ...
  const handleSettingChange = (setting, value) => {
    ...
    onSettingChange === null || onSettingChange === void 0
      ? void 0
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">Record detailed system logs</p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">Enable detailed debugging information</p>
            </div>
            <Switch
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleSettingChange('maxAgents', parseInt(e.target.value, 10))}
              className="w-32"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-400">Your API key for external services</p>
            <Input
              type="password"
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-400">URL for webhook notifications</p>
            <Input
              type="url"
