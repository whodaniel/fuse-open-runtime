...
const AppCard = forwardRef((props, ref) => {
  var { className, variant, size, asChild = false } = props,
    restProps = __rest(props, ['className', 'variant', 'size', 'asChild']);
  const Comp = asChild ? Slot : 'div';
  return (
    <Comp ref={ref} className={cn(appCardVariants({ variant, size }), className)} {...restProps} />
  );
});
AppCard.displayName = 'AppCard';
const AppCardHeader = forwardRef((props, ref) => {
  var { className, asChild = false } = props,
    restProps = __rest(props, ['className', 'asChild']);
  const Comp = asChild ? Slot : 'div';
...
const AppCardDescription = forwardRef((props, ref) => {
  ...
  return (
    <Comp ref={ref} className={cn('text-sm text-muted-foreground', className)} {...restProps} />
  );
});
...
export { AppCard, AppCardContent, AppCardDescription, AppCardFooter, AppCardHeader, AppCardTitle };
