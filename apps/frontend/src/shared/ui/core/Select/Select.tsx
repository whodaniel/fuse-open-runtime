...
const SelectTrigger = React.forwardRef((props, ref) => {
    var { className, variant, size, state, width, error, success, children } = props, restProps = __rest(props, ["className", "variant", "size", "state", "width", "error", "success", "children"]);
    const triggerState = error ? 'error' : success ? 'success' : state;
    return (<SelectPrimitive.Trigger ref={ref} className={cn(selectTriggerVariants({ variant, size, state: triggerState, width }), className)} {...restProps}>
      {children}
...
const SelectContent = React.forwardRef((props, ref) => {
    var { className, children, containerClassName, position = 'popper' } = props, restProps = __rest(props, ["className", "children", "containerClassName", "position"]);
...
const SelectItem = React.forwardRef((props, ref) => {
    var { className, children, description, icon } = props, restProps = __rest(props, ["className", "children", "description", "icon"]);
