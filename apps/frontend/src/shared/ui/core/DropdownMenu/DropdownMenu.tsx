...
const DropdownMenuSubTrigger = React.forwardRef((props, ref) => {
  var { className, inset, size, children } = props,
    restProps = __rest(props, ['className', 'inset', 'size', 'children']);
  return (
    <DropdownMenuPrimitive.SubTrigger
      ref={ref}
      className={cn(menuItemVariants({ size, inset, className }))}
      {...restProps}
    >
      {children}
...
const DropdownMenuSubContent = React.forwardRef((props, ref) => {
  var { className, size } = props,
    restProps = __rest(props, ['className', 'size']);
  return (
...
const DropdownMenuContent = React.forwardRef((props, ref) => {
  var { className, size, sideOffset = 4 } = props,
    restProps = __rest(props, ['className', 'size', 'sideOffset']);
  return (
...
const DropdownMenuItem = React.forwardRef((props, ref) => {
  var { className, inset, size } = props,
    restProps = __rest(props, ['className', 'inset', 'size']);
  return (
...
const DropdownMenuCheckboxItem = React.forwardRef((props, ref) => {
  var { className, children, checked, size } = props,
    restProps = __rest(props, ['className', 'children', 'checked', 'size']);
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ref={ref}
      className={cn(menuItemVariants({ size, inset: true, className }))}
      checked={checked}
      {...restProps}
    >
...
const DropdownMenuRadioItem = React.forwardRef((props, ref) => {
  var { className, children, size } = props,
    restProps = __rest(props, ['className', 'children', 'size']);
  return (
...
const DropdownMenuLabel = React.forwardRef((props, ref) => {
  ...
  return (
    <DropdownMenuPrimitive.Label
      ref={ref}
      className={cn(menuItemVariants({ size, inset, className }), 'font-semibold')}
      {...restProps}
    />
  );
});
