...
var Button = function (_a) {
    ...
    return (_jsx("button", { onClick: onClick, disabled: disabled, children: children }));
};
describe('Button Component', function () {
    ...
    it('should call onClick when clicked', function () { return __awaiter(void 0, void 0, void 0, function () {
        var handleClick, user, button;
    ...
    it('should not call onClick when disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
        var handleClick, user, button;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    handleClick = vi.fn();
                    user = userEvent.setup();
                    render(_jsx(Button, { onClick: handleClick, disabled: true, children: "Click me" }));
                    button = screen.getByRole('button', { name: /click me/i });
                    return [4 /*yield*/, user.click(button)];
                case 1:
                    _a.sent();
