  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="p-4 shadow-none-md border border-gray-200 rounded-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-transparent rounded-md shadow-none-md">
              ...
              {recentActivities.map((activity) => (
                <div key={activity.id} className="py-2">
                  <div className="flex justify-between">
                    <div className="flex">
                      <FiActivity
                        className={`mr-3 ${activity.type === 'user' ? 'text-blue-500' : activity.type === 'agent' ? 'text-green-500' : 'text-muted-foreground'}`}
                      />
                      <div>
