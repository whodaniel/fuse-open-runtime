...
**Pre-configured Stats (examples only — verify before publishing):**

- Uptime target (not a live SLA)
- Relay latency varies by environment
- Model count depends on configured providers
- Developer count not published on marketing site
