  ...
  return (
    ...
    >
      <motion.div
        ...
        className="text-3xl sm:text-4xl lg:text-5xl font-bold text-blue-600 dark:text-blue-400 mb-2"
      >
        {value}
        {suffix && <span className="text-2xl sm:text-3xl lg:text-4xl">{suffix}</span>}
      </motion.div>
      <div className="text-sm sm:text-base text-gray-600 dark:text-gray-300">{label}</div>
    </motion.div>
  );
};
