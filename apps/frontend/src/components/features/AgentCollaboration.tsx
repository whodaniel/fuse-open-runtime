...
export const AgentCollaboration = () => {
        ...
        switch (message.payload.action) {
          case 'agent_joined_collaboration':
            ...
            react_hot_toast_1.toast.success(
              `${message.payload.agent.name} joined the collaboration`
            );
            break;
          case 'agent_left_collaboration':
            setCollaboratingAgents((prev: any) =>
              prev.filter((agent) => agent.id !== message.payload.agentId)
            );
  ...
  return (
    <Card_1.Card className="p-4">
      <div className="flex justify-between items-center mb-6">
        ...
        {isCollaborating ? (
          <Button_1.Button
            ...
            disabled={stopCollaborationMutation.isPending}
          >
            Stop Collaboration
          </Button_1.Button>
        ) : (
          <Button_1.Button
            ...
            disabled={startCollaborationMutation.isPending || selectedAgents.length < 2}
          >
            Start Collaboration
          </Button_1.Button>
        )}
      ...
      {!isCollaborating && (
        <div className="mb-6">
          <label className="block text-sm font-medium mb-2">Select Agents to Collaborate</label>
          <Select_1.Select
            multiple
