...
const AgentCreationForm = () => {
  ...
  const handleArrayChange = (e, field) => {
    ...
    setFormData((prevState: any) =>
      Object.assign(Object.assign({}, prevState), { [field]: values })
    );
  };
  const handleLanguageProficiencyChange = (e, field) => {
    ...
    setFormData((prevState: any) =>
      Object.assign(Object.assign({}, prevState), {
        language_proficiency: Object.assign(Object.assign({}, prevState.language_proficiency), {
          [field]: value,
        }),
      })
    );
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => handleArrayChange(e, 'traits')}
            required
            placeholder="e.g., friendly, efficient, analytical"
            disabled={loading}
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) => handleArrayChange(e, 'abilities')}
            required
            placeholder="e.g., data analysis, customer support, coding"
            disabled={loading}
          />
        </div>
        <div>
          ...
          <input
            ...
            placeholder="e.g., calculator, translator, code editor"
            disabled={loading}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="Agent's area of expertise"
            disabled={loading}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            name="language_proficiency_primary"
            value={formData.language_proficiency.primary}
            onChange={(e) => handleLanguageProficiencyChange(e, 'primary')}
        ...
        <div>
          ...
          <input
            type="text"
            name="language_proficiency_secondary"
            value={formData.language_proficiency.secondary}
            onChange={(e) => handleLanguageProficiencyChange(e, 'secondary')}
