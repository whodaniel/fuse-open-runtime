      ...
      if (customData) {
        ...
        customDataPayload = await new Promise((resolve) => {
          reader.onload = (e) => {
            var _a;
            return resolve(
              JSON.parse((_a = e.target) === null || _a === void 0 ? void 0 : _a.result)
            );
          };
          reader.readAsText(customData);
        });
      }
      return agentService_1.agentService.trainAgent(
        agentId,
        Object.assign(Object.assign({}, trainingConfig), { customData: customDataPayload })
      );
    },
    onSuccess: () => {
  ...
  const validateMutation = (0, react_query_1.useMutation)({
    ...
    onSuccess: (data) => {
      react_hot_toast_1.toast.success(
        `Validation complete - Accuracy: ${(data.accuracy * 100).toFixed(2)}%`
      );
    },
    onError: (error) => {
    ...
    <Card_1.Card className="p-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="space-x-2">
          <Button_1.Button
            ...
            disabled={validateMutation.isPending || !customData}
          >
            Validate Training
          </Button_1.Button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input_1.Input
              ...
              onChange={(e) =>
                setTrainingConfig((prev: any) =>
                  Object.assign(Object.assign({}, prev), { epochs: parseInt(e.target.value) })
                )
              }
              min={1}
              max={100}
          ...
          <div>
            ...
            <Input_1.Input
              ...
              onChange={(e) =>
                setTrainingConfig((prev: any) =>
                  Object.assign(Object.assign({}, prev), { batchSize: parseInt(e.target.value) })
                )
              }
              min={1}
              max={512}
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Custom Training/Test Data</label>
        ...
        <div className="space-y-4">
          ...
          {trainingHistory && trainingHistory.history.length > 0 ? (
            <div className="space-y-4">
              <div className="h-64">
                <recharts_1.LineChart
                  width={500}
                  height={250}
                  data={formatMetrics(trainingHistory.history)}
                ...
                >
                  ...
                  {trainingHistory.history[0].metrics.val_accuracy && (
                    <recharts_1.Line
                      type="monotone"
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium">
                        {(
                          trainingHistory.history[trainingHistory.history.length - 1].metrics
                            .accuracy * 100
                        ).toFixed(2)}
                        %
                      </span>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium">
                        {trainingHistory.history[
                          trainingHistory.history.length - 1
