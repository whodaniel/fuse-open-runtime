    ...
    return [
      {
        ...
        target:
          (_a = optimizationConfig.constraints) === null || _a === void 0 ? void 0 : _a.maxLatency,
      },
      {
        name: 'Accuracy',
        value: metrics.accuracy * 100,
        target: (
          (_b = optimizationConfig.constraints) === null || _b === void 0 ? void 0 : _b.minAccuracy
        )
          ? optimizationConfig.constraints.minAccuracy * 100
          : undefined,
      },
      {
        name: 'Memory Usage',
        ...
        target:
          (_c = optimizationConfig.constraints) === null || _c === void 0 ? void 0 : _c.maxMemory,
      },
      {
        name: 'Cost per Request',
        value: metrics.costPerRequest,
        target:
          (_d = optimizationConfig.constraints) === null || _d === void 0 ? void 0 : _d.maxCost,
      },
    ];
  };
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-4">
          <div>
            ...
            <Select_1.Select
              value={optimizationConfig.target}
              onChange={(e) =>
                setOptimizationConfig((prev: any) =>
                  Object.assign(Object.assign({}, prev), { target: e.target.value })
                )
              }
            >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input_1.Input
                type="number"
                value={
                  (_a = optimizationConfig.constraints) === null || _a === void 0
                    ? void 0
                    : _a.maxLatency
                }
                onChange={(e) =>
                  setOptimizationConfig((prev: any) =>
                    Object.assign(Object.assign({}, prev), {
                      constraints: Object.assign(Object.assign({}, prev.constraints), {
            ...
            <div>
              ...
              <Input_1.Input
                ...
                value={
                  (
                    (_b = optimizationConfig.constraints) === null || _b === void 0
                      ? void 0
                      : _b.minAccuracy
                  )
                    ? optimizationConfig.constraints.minAccuracy * 100
                ...
                onChange={(e) =>
                  setOptimizationConfig((prev: any) =>
                    Object.assign(Object.assign({}, prev), {
                      constraints: Object.assign(Object.assign({}, prev.constraints), {
                        minAccuracy: parseInt(e.target.value) / 100,
                      }),
                    })
                  )
                }
            ...
            <div>
              ...
              <Input_1.Input
                type="number"
                value={
                  (_c = optimizationConfig.constraints) === null || _c === void 0
                    ? void 0
                    : _c.maxMemory
                }
                onChange={(e) =>
            ...
            <div>
              ...
              <Input_1.Input
                type="number"
                value={
                  (_d = optimizationConfig.constraints) === null || _d === void 0
                    ? void 0
                    : _d.maxCost
                }
                onChange={(e) =>
              ...
              {optimizeMutation.data && (
                <Card_1.Card className="p-4">
                  ...
                  <div className="space-y-2">
                    {Object.entries(optimizeMutation.data.improvements).map(([key, value]) => (
                  ...
                  {optimizeMutation.data.recommendations.length > 0 && (
                    <div className="mt-4">
