          ...
          <Card_1.CardContent className="space-y-4">
            <div>
              <Input_1.Input
                ...
                onChange={(e) =>
                  setNewWorkspace((prev: any) =>
                    Object.assign(Object.assign({}, prev), { name: e.target.value })
                  )
                }
              />
            </div>
            <div>
              <Input_1.Input
                ...
                onChange={(e) =>
                  setNewWorkspace((prev: any) =>
                    Object.assign(Object.assign({}, prev), { description: e.target.value })
                  )
                }
              />
            </div>
