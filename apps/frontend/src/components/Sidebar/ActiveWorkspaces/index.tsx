...
const STYLES = {
  ...
  `,
  actionsContainer: (isActive) =>
    `flex items-center gap-x-[2px] transition-opacity duration-200 ${isActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`,
  actionButton:
    'border-none rounded-md flex items-center justify-center ml-auto p-[2px] hover:bg-[#646768] text-[#A7A8A9] hover:text-white',
  settingsLink:
