...
const STYLES = {
  ...
  sidebar:
    'relative m-[16px] rounded-[16px] bg-theme-bg-sidebar border-[2px] border-theme-sidebar-border light:border-none min-w-[250px] p-[10px] h-[calc(100%-76px)]',
  content: 'flex flex-col h-full overflow-x-hidden',
  mainContent: 'flex-grow flex flex-col min-w-[235px]',
  scrollArea:
    'relative h-[calc(100%-60px)] flex flex-col w-full justify-between pt-[10px] overflow-y-scroll no-scroll',
  ...
  newWorkspaceButton:
    'light:bg-[#C2E7FE] light:hover:bg-[#7CD4FD] flex flex-grow w-[75%] h-[44px] gap-x-2 py-[5px] px-2.5 mb-2 bg-transparent rounded-[8px] text-sidebar justify-center items-center hover:bg-opacity-80 transition-all duration-300',
  footer:
    'absolute bottom-0 left-0 right-0 pt-4 pb-3 rounded-b-[16px] bg-theme-bg-sidebar bg-opacity-80 backdrop-filter backdrop-blur-md z-10',
  // Mobile styles
  mobileHeader:
    'fixed top-0 left-0 right-0 z-10 flex justify-between items-center px-4 py-2 bg-theme-bg-sidebar light:bg-transparent text-slate-200 shadow-none h-16',
  ...
  mobileSidebarContent:
    'relative h-[100vh] fixed top-0 left-0 rounded-r-[26px] bg-theme-bg-sidebar w-[80%] p-[18px]',
  ...
  mobileFooter:
    'z-99 absolute bottom-0 left-0 right-0 pt-2 pb-6 rounded-br-[26px] bg-theme-bg-sidebar bg-opacity-80 backdrop-filter backdrop-blur-md',
};
...
export default function Sidebar() {
  ...
  return (
    <div>
      <Link to={paths.home()} className={STYLES.container} aria-label="Home">
...
export function SidebarMobileHeader() {
  ...
  return (
    <>
      <div aria-label="Show sidebar" className={STYLES.mobileHeader}>
        <button
      ...
      >
        ...
        />
        <div ref={sidebarRef} className={STYLES.mobileSidebarContent}>
                  ...
                  <div className={STYLES.workspaceHeader}>
                    {(!user || user?.role !== 'default') && (
                      <button
                        ...
                        aria-label="New Workspace"
                        title="New Workspace"
                        className="flex flex-grow w-[75%] h-[44px] gap-x-2 py-[5px] px-4 bg-transparent rounded-md text-sidebar justify-center items-center hover:bg-opacity-80 transition-all duration-300"
                      >
