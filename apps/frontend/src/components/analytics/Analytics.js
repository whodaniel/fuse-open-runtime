...
var Analytics = function () {
    ...
    return (_jsxs("div", { className: "p-6", children: [_jsx(Box, { style: { borderBottom: 1, borderColor: 'divider', mb: 3 }, children: _jsxs(Tabs, { value: activeTab, onChange: function (_, newValue) { return setActiveTab(newValue); }, children: [_jsx(Tab, { label: "Performance" }), _jsx(Tab, { label: "Resources" }), _jsx(Tab, { label: "Knowledge Graph" }), _jsx(Tab, { label: "Task Analysis" })] }) }), activeTab === 0 && (_jsx(SimpleGrid, { columns: 3, children: _jsx(GridItem, { colSpan: 12, children: _jsxs(Box, { className: "p-4", children: [_jsx("h2", { className: "text-xl font-bold mb-4", children: "System Performance" }), _jsx(components_1.PerformanceMetrics, {}), _jsx("div", { className: "mt-4 h-80", children: _jsx(react_chartjs_2_1.Line, { data: performanceData, options: { maintainAspectRatio: false } }) })] }) }) })), activeTab === 1 && (_jsx(SimpleGrid, { columns: 3, children: _jsx(GridItem, { colSpan: 12, children: _jsxs(Box, { className: "p-4", children: [_jsx("h2", { className: "text-xl font-bold mb-4", children: "Resource Usage" }), _jsx(components_1.SystemMetrics, {}), _jsx("div", { className: "mt-4 h-80", children: _jsx(react_chartjs_2_1.Bar, { data: resourceUsageData, options: { maintainAspectRatio: false } }) })] }) }) })), activeTab === 2 && (_jsx(SimpleGrid, { columns: 3, children: _jsx(GridItem, { colSpan: 12, children: _jsxs(Box, { className: "p-4", children: [_jsx("h2", { className: "text-xl font-bold mb-4", children: "Knowledge Graph Analysis" }), _jsx(components_1.DynamicKnowledgeGraph, {})] }) }) })), activeTab === 3 && (_jsx(SimpleGrid, { columns: 3, children: _jsx(GridItem, { colSpan: 12, children: _jsxs(Box, { className: "p-4", children: [_jsx("h2", { className: "text-xl font-bold mb-4", children: "Task Allocation Analysis" }), _jsx(components_1.PredictiveTaskAllocator, {})] }) }) }))] }));
};
