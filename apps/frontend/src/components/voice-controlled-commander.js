...
function VoiceControlledCommander() {
    ...
    (0, react_1.useEffect)(function () {
        ...
        websocket_1.webSocketService.on('commandResponse', function (data) {
        ...
        return function () {
            if (recognition)
                recognition.stop();
            websocket_1.webSocketService.off('commandResponse', function () { });
        };
    }, []);
