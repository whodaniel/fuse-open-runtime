...
export function AppStack_LifeSaverToken({ position, onTransfer, color = '#FF6B6B' }) {
  ...
  return (
    <div className="relative">
      ...
      {showSuccess && (
        <div className="absolute right-10 top-1/2 transform -translate-y-1/2 bg-green-500 text-white px-2 py-0.5 rounded-full text-xs whitespace-nowrap shadow-none">
          Token transferred!
        </div>
      )}
    </div>
