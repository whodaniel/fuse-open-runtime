  ...
  return (
    <card_1.Card className="w-full max-w-4xl">
      ...
      <card_1.CardContent>
            ...
            {allocations.map((allocation, index) => {
              ...
              return (
                <table_1.TableRow key={index}>
                  <table_1.TableCell>
                    {(_a = tasks.find((t) => t.id === allocation.taskId)) === null || _a === void 0
                      ? void 0
                      : _a.name}
                  </table_1.TableCell>
                  <table_1.TableCell>
                    {(_b = agents.find((a) => a.id === allocation.agentId)) === null ||
                    _b === void 0
                      ? void 0
                      : _b.name}
                  </table_1.TableCell>
        ...
        <button_1.Button onClick={handleAllocate} className="mt-4 w-full">
          Allocate Tasks
        </button_1.Button>
      </card_1.CardContent>
    </card_1.Card>
