...
export function useCanViewChatHistory() {
    ...
    var _b = useState(false), viewable = _b[0], setViewable = _b[1];
    useEffect(function () {
        function fetchViewable() {
            return __awaiter(this, void 0, void 0, function () {
                var viewable;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, System.fetchCanViewChatHistory()];
                        case 1:
                            viewable = (_a.sent()).viewable;
    ...
    return { loading: loading, viewable: viewable };
}
/**
 ...
 */
export function CanViewChatHistory(_a) {
    var children = _a.children;
    var _b = useCanViewChatHistory(), loading = _b.loading, viewable = _b.viewable;
    if (loading)
 ...
 */
export function CanViewChatHistoryProvider(_a) {
    var children = _a.children;
    var _b = useCanViewChatHistory(), loading = _b.loading, viewable = _b.viewable;
    if (loading)
        return null;
    return _jsx(_Fragment, { children: children({ viewable: viewable }) });
}
