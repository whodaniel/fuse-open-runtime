import { Bot, Plus, Search, Send, Settings, Sparkles, Users, Zap } from 'lucide-react';
...
const MOCK_AGENTS: ChatAgent[] = [
  {
    ...
    description: 'Decomposes complex problems into sub-tasks.',
  },
  {
    id: '2',
    name: 'Creative-Node',
    status: 'busy',
    role: 'Divergent Thinking',
    description: 'Explores alternative solutions and edge cases.',
  },
  {
    id: '3',
    name: 'Validator-Z',
    status: 'online',
    role: 'Critique & Audit',
    description: 'Ensures factual accuracy and policy compliance.',
  },
];
...
const MOCK_HISTORY: Message[] = [
  {
    id: 'h1',
    sender: 'system',
    text: 'Swarm active. Relay initialization complete.',
    timestamp: new Date(Date.now() - 3600000).toISOString(),
    type: 'system',
  },
  {
    id: 'h2',
    sender: 'Synthesizer-01',
    text: 'Hello Commander. The collective is synchronized and awaiting distribution of directives.',
