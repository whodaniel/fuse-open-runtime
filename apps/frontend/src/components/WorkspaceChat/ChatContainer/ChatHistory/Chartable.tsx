...
export default function Chartable({ workspace, props }: ChartableProps) {
  ...
  return (
    <div className="flex justify-center items-center w-full my-4">
      <div className="bg-transparent/10 rounded-md p-4 w-full max-w-4xl">
        <h3 className="text-white text-lg font-semibold mb-2">Chart Visualization</h3>
        <div className="bg-transparent/5 rounded p-4 min-h-[200px] flex items-center justify-center">
