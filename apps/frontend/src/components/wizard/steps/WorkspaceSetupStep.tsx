        ...
        {isAIAgent ? (
          ...
          <>
            ...
            <div>
              ...
              />
              {errors.endpointUrl && <p className="text-red-600 text-sm mt-1">{errors.endpointUrl}</p>}
              <p className="text-gray-500 text-sm mt-1">The URL where The New Fuse can send requests to your agent</p>
            </div>
            
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">Authentication Type</label>
            ...
            {formData.authType === 'api_key' && (
              <div>
                ...
                <input 
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <p className="text-gray-500 text-sm mt-1">This will be stored securely and used for authentication</p>
              </div>
            )}
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">URL for receiving asynchronous notifications</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Maximum number of concurrent requests your agent can handle</p>
            </div>
          ...
          <>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">Workspace Visibility</label>
              <div className="space-y-3">
                {[
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Workspace Template</label>
              <select 
                name="template"
              ...
              <p className="text-gray-500 text-sm mt-1">Choose a template to pre-configure your workspace</p>
            </div>
            
            <hr className="border-gray-200" />
            
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">Collaboration Settings</label>
              ...
              <p className="text-gray-500 text-sm mt-1">Allow multiple users to work in the workspace simultaneously</p>
            </div>
          </>
        )}
      </div>
