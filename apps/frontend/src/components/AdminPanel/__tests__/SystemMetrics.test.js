...
describe('SystemMetrics', function () {
    it('should render loading state', function () {
        useSystemMetrics.mockReturnValue({ loading: true });
        render(_jsx(SystemMetrics, {}));
        expect(screen.getByText('Loading metrics...')).toBeInTheDocument();
    });
    it('should render metrics when loaded', function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockMetrics;
