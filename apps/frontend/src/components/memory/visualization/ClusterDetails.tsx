  ...
  return (
    <div className="cluster-details">
      ...
      <div className="content">
        <p>
          <strong>Label:</strong> {cluster.label}
        </p>
        <p>
          <strong>Size:</strong> {cluster.items.length} items
        </p>
        <p>
          <strong>Coherence:</strong> {cluster.coherence.toFixed(2)}
        </p>
        <p>
          <strong>Radius:</strong> {cluster.radius.toFixed(2)}
        </p>
        <p>
          <strong>Centroid:</strong> {Array.from(cluster.centroid).slice(0, 5).join(', ')}...
        </p>
