...
export function SessionProvider(_a) {
    ...
    useEffect(function () {
        ...
        var handleSessionExpired = function () { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, sessionManager.clearSession()];
                    case 2:
                        _a.sent();
                        router.push('/login');
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
                        console.error('Error handling expired session:', error_1);
                        return [3 /*break*/, 4];
