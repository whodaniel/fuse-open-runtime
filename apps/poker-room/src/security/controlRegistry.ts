...
export const ROUTE_SURFACE_POLICY: Record<PokerRouteView, PokerSurfaceGroup> = {
  ...
  'CASH TABLES': 'player_guest',
  TOURNAMENTS: 'player_guest',
  WALLET: 'player_guest',
  HISTORY: 'player_guest',
  TABLE: 'player_hud',
  RESULTS: 'player_guest',
  PROFILE: 'player_guest',
  PROVABLY_FAIR: 'player_guest',
  MARKETPLACE: 'player_guest',
  'COMMUNITY APPS': 'member_social',
  LEADERBOARD: 'player_guest',
  SETTINGS: 'player_guest',
};
