...
const api: WindowAPI = {
  ...
  // Copilot Integration
  copilotStart: (config) => ipcRenderer.invoke('copilot:start', config),
  copilotStop: () => ipcRenderer.invoke('copilot:stop'),
  copilotStatus: () => ipcRenderer.invoke('copilot:status'),
  copilotConfigure: (config) => ipcRenderer.invoke('copilot:configure', config),
...
const electronAPI = {
  ...
  // App integrations
  openSkIDEancer: () => ipcRenderer.invoke('app:open-ide'),
  startSkIDEancerServer: () => ipcRenderer.invoke('app:start-ide'),
  ...
  openSkIDEancerTerminal: () => ipcRenderer.invoke('app:open-ide-terminal'),
  openSkIDEancerGit: () => ipcRenderer.invoke('app:open-ide-git'),
  openSkIDEancerDebugger: () => ipcRenderer.invoke('app:open-ide-debugger'),
