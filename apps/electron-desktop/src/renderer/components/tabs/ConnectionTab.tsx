    ...
    <Container className="space-y-6">
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setTnfConfig((prev) => ({ ...prev, url: e.target.value }))
                }
            ...
            <div className="flex-1">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setTnfConfig((prev) => ({ ...prev, port: parseInt(e.target.value) || 3001 }))
                }
                min={1000}
                max={65535}
                size="sm"
      ...
      <Card className="bg-white/10 border-white/20">
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setMcpConfig((prev) => ({ ...prev, host: e.target.value }))
                }
            ...
            <div className="flex-1">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setMcpConfig((prev) => ({ ...prev, port: parseInt(e.target.value) || 3000 }))
                }
                min={1000}
                max={65535}
                size="sm"
          ...
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-400">Protocol: WebSocket</p>
