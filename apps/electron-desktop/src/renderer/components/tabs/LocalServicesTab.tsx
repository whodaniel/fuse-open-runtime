  ...
  const predefinedCommands = [
    {
      ...
      description: 'Restart a local development server',
    },
    ...
    <Container className="space-y-6">
                    ...
                    >
                      <CardContent className="p-4">
                        <div className="space-y-3">
                          ...
                          <p className="text-xs text-gray-300 text-center">{service.description}</p>
                          ...
                          <div className="flex gap-2">
                            ...
                            <Button size="sm" variant="outline" onClick={handleRefreshStatuses}>
      ...
      {!systemStatus.nativeHost && (
        <Alert variant="warning" className="rounded-lg">
          <div>
            <p className="text-sm">
              Native host is not available. Command execution and some system operations will not
              work. Ensure Python 3 is installed and the native host script is accessible.
            </p>
          </div>
        </Alert>
      )}
        ...
        <CardContent className="p-6">
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <Button onClick={handleRefreshStatuses} size="sm" variant="ghost">
            ...
            <p className="text-sm text-gray-400">Monitor local development servers and services</p>
            ...
            <div className="flex gap-2">
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setNewPort(parseInt(e.target.value) || 3000)
                }
                min={1000}
                max={65535}
                placeholder="Port"
              ...
              <Button onClick={handleAddPort} size="sm">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between items-start w-full">
                            <div className="space-y-0">
                              ...
                              {service && <p className="text-xs text-blue-300">{service.name}</p>}
                            </div>
                            <Button
                              size="sm"
                              variant="ghost"
            ...
            {monitored.length === 0 && (
              <div className="text-center py-6">
                ...
                <p className="text-sm text-gray-600">Add a port above to start monitoring</p>
              </div>
            )}
          </div>
        </CardContent>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Select
                  ...
                  options={predefinedCommands.map((cmd) => ({
                    value: cmd.value,
                    label: cmd.label,
                  }))}
                />
            ...
            <div className="bg-slate-800/30 p-3 rounded-md">
              <p className="text-sm text-gray-300">
                ...
                {predefinedCommands.find((cmd) => cmd.value === selectedCommand)?.description}
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex flex-col items-center space-y-2">
                <div
                  className={`p-3 rounded-full ${tnfRelay.connected ? 'bg-green-900' : 'bg-red-900'}`}
                >
              ...
              <div className="flex flex-col items-center space-y-2">
                <div
                  className={`p-3 rounded-full ${systemStatus.nativeHost ? 'bg-green-900' : 'bg-red-900'}`}
                >
                  <FiActivity
                    color={systemStatus.nativeHost ? 'lightgreen' : 'lightcoral'}
                    size="24"
                  />
                </div>
              ...
              <div className="flex flex-col items-center space-y-2">
                <div
                  className={`p-3 rounded-full ${statuses.some((s) => s.isOpen) ? 'bg-green-900' : 'bg-red-900'}`}
                >
                  <FiServer
                    color={statuses.some((s) => s.isOpen) ? 'lightgreen' : 'lightcoral'}
                    size="24"
                  />
                </div>
