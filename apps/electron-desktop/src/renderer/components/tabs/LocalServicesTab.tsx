                      ...
                      <CardBody>
                        <VStack spacing={3}>
                          <HStack justify="space-between" w="100%">
                            ...
                            <Badge colorScheme={isRunning ? 'green' : 'red'} variant="solid">
                ...
                return (
                  <GridItem key={port}>
                    <Card
                      ...
                      bg="whiteAlpha.50"
                      borderColor={
                        status ? getStatusColor(status.isOpen) + '.400' : 'whiteAlpha.200'
                      }
        ...
        <CardBody>
          <VStack spacing={4} align="stretch">
            <HStack justify="space-between">
              ...
              <Badge colorScheme={systemStatus.nativeHost ? 'green' : 'red'} variant="solid">
            ...
            <Grid templateColumns="1fr 2fr" gap={4}>
              <GridItem>
                <FormControl>
                  <FormLabel fontSize="sm" htmlFor="command-type-select">
                    Command Type
                  </FormLabel>
                  <select
            ...
            <Grid templateColumns="repeat(auto-fit, minmax(150px, 1fr))" gap={4}>
              <GridItem>
                <VStack>
                  <Box p={3} bg={tnfRelay.connected ? 'green.900' : 'red.900'} borderRadius="full">
                    <Icon
                      as={FiServer}
                      color={tnfRelay.connected ? 'lightgreen' : 'lightcoral'}
                      boxSize="24px"
                    />
                  </Box>
              ...
              <GridItem>
                <VStack>
                  <Box
                    p={3}
                    bg={systemStatus.nativeHost ? 'green.900' : 'red.900'}
                    borderRadius="full"
                  >
                    <Icon
                      as={FiActivity}
              ...
              <GridItem>
                <VStack>
                  <Box
                    p={3}
                    bg={statuses.some((s) => s.isOpen) ? 'green.900' : 'red.900'}
                    borderRadius="full"
                  >
                    <Icon
                      as={FiServer}
                  ...
                  <Badge
                    colorScheme={statuses.some((s) => s.isOpen) ? 'green' : 'red'}
                    variant="subtle"
                  >
