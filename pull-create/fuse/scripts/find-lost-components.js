...
async function main() {
  ...
  console.log(`\nAnalysis complete!`);
  console.log(`Found ${results.stats.totalComponents} components and ${results.stats.totalPages} pages`);
  console.log(`Identified ${results.stats.potentiallyLostCount} potentially lost components/pages`);
  console.log(`Results written to ${config.outputFile}`);
  console.log(`Detailed log written to ${config.logFile}`);
}
...
/**
 * Analyze a file to determine if it's a component/page and find references
 */
