...
_Reference these descriptors when prompting Stitch._

- **The "Vibe" (Adjectives):**
  - _Primary:_ [Main aesthetic keyword]
  - _Secondary:_ [Supporting aesthetic]
  - _Tertiary:_ [Additional flavor]
...
_Update this when a new page is successfully merged._
...
_Pick the next task from here if available._
...
Generate this using the `design-md` skill from an existing Stitch screen, or
create manually:
