...
Searchable database of UI styles, color palettes, font pairings, chart types,
product recommendations, UX guidelines, and stack-specific best practices.
...
Use `search.py` multiple times to gather comprehensive information. Search until
...
4. **Color** - Get color palette (Primary, Secondary, CTA, Background, Text,
   Border)
...
7. **Split Into Multiple Files** - For better maintainability:
   - Separate components into individual files (e.g., `Header.tsx`,
     `Footer.tsx`)
