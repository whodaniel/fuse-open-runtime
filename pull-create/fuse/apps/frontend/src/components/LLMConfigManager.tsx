      ...
      <div className="space-y-4">
        <div>
          ...
          <ui_1.Select
            ...
            options={Object.values(providers_1.SUPPORTED_PROVIDERS).map((provider) => ({
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <ui_1.Input
                ...
                onChange={(e: any) => handleParameterChange('maxTokens', parseInt(e.target.value))}
              />
            </div>
            ...
            <div>
              ...
              <ui_1.Input
                ...
                onChange={(e: any) => handleParameterChange('topP', parseFloat(e.target.value))}
              />
            </div>
            ...
            <div>
              ...
              <ui_1.Input
                ...
                onChange={(e: any) =>
                  handleParameterChange('frequencyPenalty', parseFloat(e.target.value))
                }
              />
            </div>
          </div>
