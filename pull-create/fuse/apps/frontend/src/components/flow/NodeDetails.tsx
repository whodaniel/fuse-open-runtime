...
export const NodeDetails = ({ nodes, onNodeUpdate }) => {
      ...
      onNodeUpdate(node.id, {
        data: Object.assign(Object.assign({}, node.data), {
          parameters: Object.assign(
            Object.assign({}, (_a = node.data) === null || _a === void 0 ? void 0 : _a.parameters),
            { [paramKey]: value }
          ),
        }),
      });
  ...
  return (
    <core_1.Card className="max-w-2xl mx-auto">
      <core_1.CardHeader>
        <core_1.CardTitle>
          {((_a = node.data) === null || _a === void 0 ? void 0 : _a.label) || 'Unnamed Node'}
        </core_1.CardTitle>
        <core_1.CardDescription>
          ID: {node.id} • Type:{' '}
          {((_b = node.data) === null || _b === void 0 ? void 0 : _b.type) || 'Unknown'}
        </core_1.CardDescription>
      </core_1.CardHeader>
