      ...
      <div className="node-content">
        <div className="form-group" style={{ marginBottom: '10px' }}>
          ...
          <select
            ...
            onChange={(e) => onParameterChange('method', e.target.value)}
            style={{
              width: '100%',
              padding: '5px',
              marginTop: '5px',
        ...
        <div className="form-group" style={{ marginBottom: '10px' }}>
          ...
          <input
            ...
            onChange={(e) => onParameterChange('url', e.target.value)}
        ...
        <div className="form-group" style={{ marginBottom: '10px' }}>
          ...
          <textarea
            value={data.parameters.headers ? JSON.stringify(data.parameters.headers, null, 2) : ''}
            onChange={(e) => {
              try {
