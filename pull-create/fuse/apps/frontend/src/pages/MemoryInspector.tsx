  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-gray-600 dark:text-gray-400">Agent ID: <span className="font-mono bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-sm">{agentId}</span></p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 w-full overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <p className="text-gray-600 dark:text-gray-400 italic">No memory entries found for this agent.</p>
