...
chmod +x "./scripts/consolidated-dependencies.sh"
chmod +x "./scripts/consolidate-frontend.sh"
chmod +x "./scripts/cleanup-redundant-scripts.sh"

# Step 1: Run consolidated dependencies script
echo "📦 Step 1: Running consolidated dependencies script..."
"./scripts/consolidated-dependencies.sh"

# Step 2: Run frontend consolidation script
echo "🔄 Step 2: Running frontend consolidation script..."
"./scripts/consolidate-frontend.sh"
