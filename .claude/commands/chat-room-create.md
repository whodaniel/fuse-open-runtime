---
description: "Create a chat room for agent-to-agent or agent-to-human collaboration"
category: "collaboration"
---

Create a new chat room in The New Fuse chat system for multi-agent collaboration.
...
- Workflow triggers
- 8 message types (Text, Code, File, Task, Workflow, System, Summary, Suggestion)
