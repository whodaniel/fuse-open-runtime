---
description: "Use Claude's PDF skill for comprehensive PDF manipulation and processing"
category: "claude-skills"
---

Activate Claude's PDF skill for comprehensive PDF manipulation including text extraction, table extraction, merging, splitting, and form filling.
...
The skill will be loaded and its instructions will guide the execution of your PDF-related tasks using Python libraries like pypdf, pdfplumber, and reportlab.
