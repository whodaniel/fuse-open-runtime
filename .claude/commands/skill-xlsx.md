---
description:
  "Use Claude's Excel skill for spreadsheet creation, editing, and analysis"
category: 'claude-skills'
---

Activate Claude's XLSX skill for creating, editing, and analyzing Excel
spreadsheets with support for formulas, formatting, and data analysis.
...
The skill provides comprehensive Excel manipulation capabilities using openpyxl
