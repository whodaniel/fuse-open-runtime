# Agent setup for `The-New-Fuse`

This is a deepsec scanning workspace. Project `The-New-Fuse` was just registered
(target: `..`). Setup is incomplete — `data/The-New-Fuse/INFO.md`
...
2. **Fill in `data/The-New-Fuse/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id The-New-Fuse
pnpm deepsec process --project-id The-New-Fuse
```
