...
// Dark theme variant
export const darkPurpleBlueTheme = {
...
export function generateThemeCSS(theme, isDark = false) {
    return `
    :root {
...
export function createMaterialUITheme(colors, isDark = false) {
    return {
        palette: {
...
// Apply theme to page
export function applyThemeToPage(theme, isDark = false) {
...
export class ThemeManager {
    constructor() {
        this.currentTheme = purpleBlueTheme;
        this.isDark = false;
...
//# sourceMappingURL=enhanced-theme.js.map