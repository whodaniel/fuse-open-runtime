...
describe('AIModelsManager', () => {
    ...
    beforeEach(() => {
        ...
        mockWsManager = new WebSocketManager('ws://localhost:3712');
    ...
    test('should set default model', () => {
        ...
        expect(chrome.storage.local.set).toHaveBeenCalledWith({ defaultAIModel: 'claude-3' }, expect.any(Function));
    ...
    test('should handle AI query', async () => {
        ...
        const messageHandler = mockWsManager.addListener.mock.calls.find(call => call[0] === 'message')?.[1];
...
//# sourceMappingURL=ai-models.test.js.map