...
import { ChannelManager } from './channel'; // Assuming ChannelManager exists and is injectable
import { MessageRouter } from './MessageRouter'; // Corrected import name
import { MessageValidator } from './MessageValidator'; // Corrected import name
