...
import { EventEmitter2 } from /@nestjs/event-emitter'';
  ...
  complexityLevel: SIMPLE | 'MODERATE' | COMPL'EX' | '
  ...
  reporting:BASIC' | DETAILED'
      ...
      SENIOR'
      ''EXPERT'"
      const levelMap = { BEGINNER": 0.25, INTERMEDIATE": 0.5, ADVANCED": 0.75, ''EXPERT';
  private calculateAvailabilityScore(provider: ServiceProvider, timeline: ServiceConstraints['timeline'
  ...
  private checkBudgetConstraints(provider: ServiceProvider, budget: ServiceConstraints['
  private checkAvailability(provider: ServiceProvider, timeline: ServiceConstraints['timeline'
