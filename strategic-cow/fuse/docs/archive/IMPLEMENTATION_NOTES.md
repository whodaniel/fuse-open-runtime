...
- **Changes**:
  ...
  - ✅ Updated imports: removed `@nestjs/typeorm`, added `DrizzleService`
...
2. **apps/api/src/controllers/health.controller.ts**
   ...
   - Added: `DrizzleService` import
   - Changed constructor injection from `Repository<User>` to `DrizzleService`
