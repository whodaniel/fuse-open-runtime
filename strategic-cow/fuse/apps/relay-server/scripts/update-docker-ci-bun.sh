...
if [ -f ".github/workflows/ci.yml" ]; then
    ...
    sed -i.bak 's/pnpm install/pnpm install/g' .github/workflows/ci.yml
    sed -i.bak 's/pnpm run build/pnpm run build/g' .github/workflows/ci.yml
    sed -i.bak 's/pnpm run test/pnpm run test/g' .github/workflows/ci.yml
    sed -i.bak 's/pnpm run lint/pnpm run lint/g' .github/workflows/ci.yml
...
for file in .github/workflows/*.yml .github/workflows/*.yaml; do
    if [ -f "$file" ] && [ "$file" != ".github/workflows/ci.yml" ]; then
        ...
        sed -i.bak 's/pnpm install/pnpm install/g' "$file"
        sed -i.bak 's/pnpm run build/pnpm run build/g' "$file"
        sed -i.bak 's/pnpm run test/pnpm run test/g' "$file"
        sed -i.bak 's/pnpm run lint/pnpm run lint/g' "$file"
