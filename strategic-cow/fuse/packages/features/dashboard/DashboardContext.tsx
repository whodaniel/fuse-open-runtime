...
var dashboardReducer = function (state, action): any {
    switch (action.type) {
        case 'SET_CURRENT_LAYOUT':
            return __assign(__assign({}, state), { currentLayout: action.payload });
        case 'UPDATE_WIDGET':
            return __assign(__assign({}, state), { widgets: state.widgets.map(function (widget): any {
                    return widget.id === action.payload.id
                        ? __assign(__assign({}, widget), action.payload.data) : widget;
                }) });
        case 'UPDATE_LAYOUT':
            return __assign(__assign({}, state), { layouts: state.layouts.map(function (layout): any {
...
var DashboardProvider = function (_a): any {
    ...
    var setCurrentLayout = (0, react_1.useCallback)(function (id): any {
        dispatch({ type: SET_CURRENT_LAYOUT', payload: id });
    }, []);
    var updateWidget = (0, react_1.useCallback)(function (id, data): any {
        dispatch({ type: UPDATE_WIDGET', payload: { id: id, data: data } });
    }, []);
    var updateLayout = (0, react_1.useCallback)(function (layout): any {
        dispatch({ type: UPDATE_LAYOUT', payload: layout });
    }, []);
    var refreshWidget = (0, react_1.useCallback)(function (id): any { return __awaiter(void 0, void 0, void 0, function () {
