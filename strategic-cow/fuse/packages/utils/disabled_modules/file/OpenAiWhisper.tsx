...
class OpenAiWhisper {
    ...
    async processFile(): Promise<void> {fullFilePath) {
        try {
...
_OpenAiWhisper_instances = new WeakSet(), _OpenAiWhisper_log = function _OpenAiWhisper_log(text, ...args): any {
    
};
//# sourceMappingURL=OpenAiWhisper.js.mapexport {};
