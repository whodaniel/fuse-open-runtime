...
export class RelayBridge {
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      this.mcpSystem = MCPSystemFactory.createCustomSystem(systemConfig as MCPSystemConfig);
 ...
 */
export function createRelayBridge(config: RelayBridgeConfig): RelayBridge {
 ...
 */
export async function replaceMCPTransport(
