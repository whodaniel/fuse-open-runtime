tell application "Google Chrome"
	...
	set newTab to make new tab at end of tabs of front window with properties {URL:"https://labs.google/fx/tools/flow/project/be98b53f-bd41-4afc-b9e4-469f7744045e"}

	-- We use a small delay here to ensure the tab is ready
	delay 4
	...
	set jsCode to "
		...
		downloadImages();
	"
	execute newTab javascript jsCode
end tell
