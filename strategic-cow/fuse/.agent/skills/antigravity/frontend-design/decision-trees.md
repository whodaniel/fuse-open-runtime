...
> Context-based design THINKING, not fixed solutions. **These are decision
> GUIDES, not copy-paste templates.** **For UX psychology principles (Hick's,
> Fitts', etc.) see:** [ux-psychology.md](ux-psychology.md)
...
> **Remember**: These templates show STRUCTURE and THINKING process. Every
> project needs fresh color, typography, and styling decisions based on its
> unique context. ASK when unclear.
