...
# Build script that ensures Theia is built with yarn as required (v2)
# Includes manual rebuilds for problematic native modules.

set -e

echo "🚀 Building The New Fuse with yarn-based Theia build (v2)..."
